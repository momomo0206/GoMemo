...
import (
	...
	mast "github.com/momomo0206/gomemo/plugin/markdown/ast"
	"github.com/momomo0206/gomemo/plugin/markdown/extensions"
	"github.com/momomo0206/gomemo/plugin/markdown/renderer"
	storepb "github.com/momomo0206/gomemo/proto/gen/store"
)

// ExtractData contains all metadata extracted from markdown in a single pass.
...
type Service interface {
	...
	ExtractAll(content []byte) (*ExtractData, error)
...
func NewService(opts ...Option) Service {
	...
	exts := []goldmark.Extender{
		extension.GFM, // Github Flavored Markdown (tables, strikethrough, task list, autolinks)
	}
...
func (s *service) ExtractAll(content []byte) (*ExtractData, error) {
	root, err := s.parse(content)
	if err != nil {
		return nil, err
	}
