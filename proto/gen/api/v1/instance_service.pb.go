...
type UpdateInstanceSettingRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The instance setting resource which replace the resource on the server.
...
type InstanceSetting_GeneralSetting struct {
	...
	DisallowUserRegistrarion bool `protobuf:"varint,2,opt,name=disallow_user_registrarion,json=disallowUserRegistrarion,proto3" json:"disallow_user_registrarion,omitempty"`
...
func (x *InstanceSetting_GeneralSetting) GetDisallowUserRegistrarion() bool {
	if x != nil {
		return x.DisallowUserRegistrarion
	}
	return false
}
...
type InstanceSetting_StorageSetting struct {
	...
	StorageType InstanceSetting_StorageSetting_StorageType `protobuf:"varint,1,opt,name=storage_type,json=storageType,proto3,enum=gomemo.api.v1.InstanceSetting_StorageSetting_StorageType" json:"storage_type,omitempty"`
...
const file_api_v1_instance_service_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/v1/instance_service.proto\x12\rgomemo.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a google/protobuf/field_mask.proto\"x\n" +
	...
	"\x19GetInstanceProfileRequest\"\xa0\x0f\n" +
	"\x0fInstanceSetting\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12X\n" +
	"\x0fgeneral_setting\x18\x02 \x01(\v2-.gomemo.api.v1.InstanceSetting.GeneralSettingH\x00R\x0egeneralSetting\x12X\n" +
	"\x0fstorage_setting\x18\x03 \x01(\v2-.gomemo.api.v1.InstanceSetting.StorageSettingH\x00R\x0estorageSetting\x12e\n" +
	"\x14memo_related_setting\x18\x04 \x01(\v21.gomemo.api.v1.InstanceSetting.MemoRelatedSettingH\x00R\x12memoRelatedSetting\x1a\xcb\x04\n" +
	"\x0eGeneralSetting\x12<\n" +
	"\x1adisallow_user_registrarion\x18\x02 \x01(\bR\x18disallowUserRegistrarion\x124\n" +
	...
	"\x0ecustom_profile\x18\x06 \x01(\v2;.gomemo.api.v1.InstanceSetting.GeneralSetting.CustomProfileR\rcustomProfile\x121\n" +
	...
	"\blogo_url\x18\x03 \x01(\tR\alogoUrl\x1a\xbe\x04\n" +
	"\x0eStorageSetting\x12\\\n" +
	"\fstorage_type\x18\x01 \x01(\x0e29.gomemo.api.v1.InstanceSetting.StorageSetting.StorageTypeR\vstorageType\x12+\n" +
	"\x11filepath_template\x18\x02 \x01(\tR\x10filepathTemplate\x12/\n" +
	"\x14upload_size_limit_mb\x18\x03 \x01(\x03R\x11uploadSizeLimitMb\x12S\n" +
	"\ts3_config\x18\x04 \x01(\v26.gomemo.api.v1.InstanceSetting.StorageSetting.S3ConfigR\bs3Config\x1a\xcc\x01\n" +
	"\bS3Config\x12\"\n" +
	...
	"\fMEMO_RELATED\x10\x03:b\xeaA_\n" +
	"\x1dgomemo.api.v1/InstanceSetting\x12\x1binstance/settings/{setting}*\x10instanceSettings2\x0finstanceSettingB\a\n" +
	"\x05value\"V\n" +
	"\x19GetInstanceSettingRequest\x129\n" +
	"\x04name\x18\x01 \x01(\tB%\xe0A\x02\xfaA\x1f\n" +
	"\x1dgomemo.api.v1/InstanceSettingR\x04name\"\x9f\x01\n" +
	"\x1cUpdateInstanceSettingRequest\x12=\n" +
	"\asetting\x18\x01 \x01(\v2\x1e.gomemo.api.v1.InstanceSettingB\x03\xe0A\x02R\asetting\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\n" +
	"updateMask2\xe2\x03\n" +
	"\x0fInstanceService\x12\x80\x01\n" +
	"\x12GetInstanceProfile\x12(.gomemo.api.v1.GetInstanceProfileRequest\x1a\x1e.gomemo.api.v1.InstanceProfile\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/api/v1/instance/profile\x12\x91\x01\n" +
	"\x12GetInstanceSetting\x12(.gomemo.api.v1.GetInstanceSettingRequest\x1a\x1e.gomemo.api.v1.InstanceSetting\"1\xdaA\x04name\x82\xd3\xe4\x93\x02$\x12\"/api/v1/{name=instance/settings/*}\x12\xb7\x01\n" +
	"\x15UpdateInstanceSetting\x12+.gomemo.api.v1.UpdateInstanceSettingRequest\x1a\x1e.gomemo.api.v1.InstanceSetting\"Q\xdaA\x13setting,update_mask\x82\xd3\xe4\x93\x025:\asetting2*/api/v1/{setting.name=instance/settings/*}B\xb4\x01\n" +
	"\x11com.gomemo.api.v1B\x14InstanceServiceProtoP\x01Z3github.com/momomo0206/gomemo/proto/gen/api/v1;apiv1\xa2\x02\x03GAX\xaa\x02\rGomemo.Api.V1\xca\x02\rGomemo\\Api\\V1\xe2\x02\x19Gomemo\\Api\\V1\\GPBMetadata\xea\x02\x0fGomemo::Api::V1b\x06proto3"
...
var file_api_v1_instance_service_proto_goTypes = []any{
	(InstanceSetting_Key)(0),                             // 0: gomemo.api.v1.InstanceSetting.Key
	(InstanceSetting_StorageSetting_StorageType)(0),      // 1: gomemo.api.v1.InstanceSetting.StorageSetting.StorageType
	(*InstanceProfile)(nil),                              // 2: gomemo.api.v1.InstanceProfile
	(*GetInstanceProfileRequest)(nil),                    // 3: gomemo.api.v1.GetInstanceProfileRequest
	(*InstanceSetting)(nil),                              // 4: gomemo.api.v1.InstanceSetting
	(*GetInstanceSettingRequest)(nil),                    // 5: gomemo.api.v1.GetInstanceSettingRequest
	(*UpdateInstanceSettingRequest)(nil),                 // 6: gomemo.api.v1.UpdateInstanceSettingRequest
	(*InstanceSetting_GeneralSetting)(nil),               // 7: gomemo.api.v1.InstanceSetting.GeneralSetting
	(*InstanceSetting_StorageSetting)(nil),               // 8: gomemo.api.v1.InstanceSetting.StorageSetting
	(*InstanceSetting_MemoRelatedSetting)(nil),           // 9: gomemo.api.v1.InstanceSetting.MemoRelatedSetting
	(*InstanceSetting_GeneralSetting_CustomProfile)(nil), // 10: gomemo.api.v1.InstanceSetting.GeneralSetting.CustomProfile
	(*InstanceSetting_StorageSetting_S3Config)(nil),      // 11: gomemo.api.v1.InstanceSetting.StorageSetting.S3Config
	(*fieldmaskpb.FieldMask)(nil),                        // 12: google.protobuf.FieldMask
}
var file_api_v1_instance_service_proto_depIdxs = []int32{
	7,  // 0: gomemo.api.v1.InstanceSetting.general_setting:type_name -> gomemo.api.v1.InstanceSetting.GeneralSetting
	8,  // 1: gomemo.api.v1.InstanceSetting.storage_setting:type_name -> gomemo.api.v1.InstanceSetting.StorageSetting
	9,  // 2: gomemo.api.v1.InstanceSetting.memo_related_setting:type_name -> gomemo.api.v1.InstanceSetting.MemoRelatedSetting
	4,  // 3: gomemo.api.v1.UpdateInstanceSettingRequest.setting:type_name -> gomemo.api.v1.InstanceSetting
	12, // 4: gomemo.api.v1.UpdateInstanceSettingRequest.update_mask:type_name -> google.protobuf.FieldMask
	10, // 5: gomemo.api.v1.InstanceSetting.GeneralSetting.custom_profile:type_name -> gomemo.api.v1.InstanceSetting.GeneralSetting.CustomProfile
	1,  // 6: gomemo.api.v1.InstanceSetting.StorageSetting.storage_type:type_name -> gomemo.api.v1.InstanceSetting.StorageSetting.StorageType
	11, // 7: gomemo.api.v1.InstanceSetting.StorageSetting.s3_config:type_name -> gomemo.api.v1.InstanceSetting.StorageSetting.S3Config
	3,  // 8: gomemo.api.v1.InstanceService.GetInstanceProfile:input_type -> gomemo.api.v1.GetInstanceProfileRequest
	5,  // 9: gomemo.api.v1.InstanceService.GetInstanceSetting:input_type -> gomemo.api.v1.GetInstanceSettingRequest
	6,  // 10: gomemo.api.v1.InstanceService.UpdateInstanceSetting:input_type -> gomemo.api.v1.UpdateInstanceSettingRequest
	2,  // 11: gomemo.api.v1.InstanceService.GetInstanceProfile:output_type -> gomemo.api.v1.InstanceProfile
	4,  // 12: gomemo.api.v1.InstanceService.GetInstanceSetting:output_type -> gomemo.api.v1.InstanceSetting
	4,  // 13: gomemo.api.v1.InstanceService.UpdateInstanceSetting:output_type -> gomemo.api.v1.InstanceSetting
