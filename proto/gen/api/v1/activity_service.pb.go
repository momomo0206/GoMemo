...
type Activity struct {
	...
	Type Activity_Type `protobuf:"varint,3,opt,name=type,proto3,enum=gomemo.api.v1.Activity_Type" json:"type,omitempty"`
	// The level of the activity.
	Level Activity_Level `protobuf:"varint,4,opt,name=level,proto3,enum=gomemo.api.v1.Activity_Level" json:"level,omitempty"`
...
const file_api_v1_activity_service_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/v1/activity_service.proto\x12\rgomemo.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf6\x03\n" +
	"\bActivity\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xe0A\x03\xe0A\bR\x04name\x12\x1d\n" +
	"\acreator\x18\x02 \x01(\tB\x03\xe0A\x03R\acreator\x125\n" +
	"\x04type\x18\x03 \x01(\x0e2\x1c.gomemo.api.v1.Activity.TypeB\x03\xe0A\x03R\x04type\x128\n" +
	"\x05level\x18\x04 \x01(\x0e2\x1d.gomemo.api.v1.Activity.LevelB\x03\xe0A\x03R\x05level\x12@\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12=\n" +
	"\apayload\x18\x06 \x01(\v2\x1e.gomemo.api.v1.ActivityPayloadB\x03\xe0A\x03R\apayload\".\n" +
	"\x04Type\x12\x14\n" +
	...
	"\x04WARN\x10\x02\x12\t\n" +
	"\x05ERROR\x10\x03:N\xeaAK\n" +
	"\x16gomemo.api.v1/Activity\x12\x15activities/{activity}\x1a\x04name*\n" +
	"activities2\bactivity\"l\n" +
	"\x0fActivityPayload\x12N\n" +
	"\fmemo_comment\x18\x01 \x01(\v2).gomemo.api.v1.ActivityMemoCommentPayloadH\x00R\vmemoCommentB\t\n" +
	"\apayload\"S\n" +
	...
	"\n" +
	"activities\x18\x01 \x03(\v2\x17.gomemo.api.v1.ActivityR\n" +
	"activities\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"H\n" +
	"\x12GetActivityRequest\x122\n" +
	"\x04name\x18\x01 \x01(\tB\x1e\xe0A\x02\xfaA\x18\n" +
	"\x16gomemo.api.v1/ActivityR\x04name2\x83\x02\n" +
	"\x0fActivityService\x12y\n" +
	"\x0eListActivities\x12$.gomemo.api.v1.ListActivitiesRequest\x1a%.gomemo.api.v1.ListActivitiesResponse\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/api/v1/activities\x12u\n" +
	"\vGetActivity\x12!.gomemo.api.v1.GetActivityRequest\x1a\x17.gomemo.api.v1.Activity\"*\xdaA\x04name\x82\xd3\xe4\x93\x02\x1d\x12\x1b/api/v1/{name=activities/*}B\xb4\x01\n" +
	"\x11com.gomemo.api.v1B\x14ActivityServiceProtoP\x01Z3github.com/momomo0206/gomemo/proto/gen/api/v1;apiv1\xa2\x02\x03GAX\xaa\x02\rGomemo.Api.V1\xca\x02\rGomemo\\Api\\V1\xe2\x02\x19Gomemo\\Api\\V1\\GPBMetadata\xea\x02\x0fGomemo::Api::V1b\x06proto3"
...
var file_api_v1_activity_service_proto_goTypes = []any{
	(Activity_Type)(0),                 // 0: gomemo.api.v1.Activity.Type
	(Activity_Level)(0),                // 1: gomemo.api.v1.Activity.Level
	(*Activity)(nil),                   // 2: gomemo.api.v1.Activity
	(*ActivityPayload)(nil),            // 3: gomemo.api.v1.ActivityPayload
	(*ActivityMemoCommentPayload)(nil), // 4: gomemo.api.v1.ActivityMemoCommentPayload
	(*ListActivitiesRequest)(nil),      // 5: gomemo.api.v1.ListActivitiesRequest
	(*ListActivitiesResponse)(nil),     // 6: gomemo.api.v1.ListActivitiesResponse
	(*GetActivityRequest)(nil),         // 7: gomemo.api.v1.GetActivityRequest
	(*timestamppb.Timestamp)(nil),      // 8: google.protobuf.Timestamp
}
var file_api_v1_activity_service_proto_depIdxs = []int32{
	0, // 0: gomemo.api.v1.Activity.type:type_name -> gomemo.api.v1.Activity.Type
	1, // 1: gomemo.api.v1.Activity.level:type_name -> gomemo.api.v1.Activity.Level
	8, // 2: gomemo.api.v1.Activity.create_time:type_name -> google.protobuf.Timestamp
	3, // 3: gomemo.api.v1.Activity.payload:type_name -> gomemo.api.v1.ActivityPayload
	4, // 4: gomemo.api.v1.ActivityPayload.memo_comment:type_name -> gomemo.api.v1.ActivityMemoCommentPayload
	2, // 5: gomemo.api.v1.ListActivitiesResponse.activities:type_name -> gomemo.api.v1.Activity
	5, // 6: gomemo.api.v1.ActivityService.ListActivities:input_type -> gomemo.api.v1.ListActivitiesRequest
	7, // 7: gomemo.api.v1.ActivityService.GetActivity:input_type -> gomemo.api.v1.GetActivityRequest
	6, // 8: gomemo.api.v1.ActivityService.ListActivities:output_type -> gomemo.api.v1.ListActivitiesResponse
	2, // 9: gomemo.api.v1.ActivityService.GetActivity:output_type -> gomemo.api.v1.Activity
