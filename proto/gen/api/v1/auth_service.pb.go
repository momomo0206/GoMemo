...
type SignInRequest_SSOCredentials struct {
	...
	// The authentication code from the SSO provider.
...
const file_api_v1_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x19api/v1/auth_service.proto\x12\rgomemo.api.v1\x1a\x19api/v1/user_service.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x17\n" +
	"\x15GetCurrentUserRequest\"A\n" +
	"\x16GetCurrentUserResponse\x12'\n" +
	"\x04user\x18\x01 \x01(\v2\x13.gomemo.api.v1.UserR\x04user\"\xd0\x03\n" +
	"\rSignInRequest\x12e\n" +
	"\x14password_credentials\x18\x01 \x01(\v20.gomemo.api.v1.SignInRequest.PasswordCredentialsH\x00R\x13passwordCredentials\x12V\n" +
	"\x0fsso_credentials\x18\x02 \x01(\v2+.gomemo.api.v1.SignInRequest.SSOCredentialsH\x00R\x0essoCredentials\x1aW\n" +
	...
	"\vcredentials\"\xaf\x01\n" +
	"\x0eSignInResponse\x12'\n" +
	"\x04user\x18\x01 \x01(\v2\x13.gomemo.api.v1.UserR\x04user\x12!\n" +
	...
	"\n" +
	"expires_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAt2\xc6\x03\n" +
	"\vAuthService\x12v\n" +
	"\x0eGetCurrentUser\x12$.gomemo.api.v1.GetCurrentUserRequest\x1a%.gomemo.api.v1.GetCurrentUserResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/api/v1/auth/me\x12e\n" +
	"\x06SignIn\x12\x1c.gomemo.api.v1.SignInRequest\x1a\x1d.gomemo.api.v1.SignInResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/api/v1/auth/signin\x12^\n" +
	"\aSignOut\x12\x1d.gomemo.api.v1.SignOutRequest\x1a\x16.google.protobuf.Empty\"\x1c\x82\xd3\xe4\x93\x02\x16\"\x14/api/v1/auth/signout\x12x\n" +
	"\fRefreshToken\x12\".gomemo.api.v1.RefreshTokenRequest\x1a#.gomemo.api.v1.RefreshTokenResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/api/v1/auth/refreshB\xb0\x01\n" +
	"\x11com.gomemo.api.v1B\x10AuthServiceProtoP\x01Z3github.com/momomo0206/gomemo/proto/gen/api/v1;apiv1\xa2\x02\x03GAX\xaa\x02\rGomemo.Api.V1\xca\x02\rGomemo\\Api\\V1\xe2\x02\x19Gomemo\\Api\\V1\\GPBMetadata\xea\x02\x0fGomemo::Api::V1b\x06proto3"
...
var file_api_v1_auth_service_proto_goTypes = []any{
	(*GetCurrentUserRequest)(nil),             // 0: gomemo.api.v1.GetCurrentUserRequest
	(*GetCurrentUserResponse)(nil),            // 1: gomemo.api.v1.GetCurrentUserResponse
	(*SignInRequest)(nil),                     // 2: gomemo.api.v1.SignInRequest
	(*SignInResponse)(nil),                    // 3: gomemo.api.v1.SignInResponse
	(*SignOutRequest)(nil),                    // 4: gomemo.api.v1.SignOutRequest
	(*RefreshTokenRequest)(nil),               // 5: gomemo.api.v1.RefreshTokenRequest
	(*RefreshTokenResponse)(nil),              // 6: gomemo.api.v1.RefreshTokenResponse
	(*SignInRequest_PasswordCredentials)(nil), // 7: gomemo.api.v1.SignInRequest.PasswordCredentials
	(*SignInRequest_SSOCredentials)(nil),      // 8: gomemo.api.v1.SignInRequest.SSOCredentials
	(*User)(nil),                              // 9: gomemo.api.v1.User
	(*timestamppb.Timestamp)(nil),             // 10: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),                     // 11: google.protobuf.Empty
}
var file_api_v1_auth_service_proto_depIdxs = []int32{
	9,  // 0: gomemo.api.v1.GetCurrentUserResponse.user:type_name -> gomemo.api.v1.User
	7,  // 1: gomemo.api.v1.SignInRequest.password_credentials:type_name -> gomemo.api.v1.SignInRequest.PasswordCredentials
	8,  // 2: gomemo.api.v1.SignInRequest.sso_credentials:type_name -> gomemo.api.v1.SignInRequest.SSOCredentials
	9,  // 3: gomemo.api.v1.SignInResponse.user:type_name -> gomemo.api.v1.User
	10, // 4: gomemo.api.v1.SignInResponse.access_token_expires_at:type_name -> google.protobuf.Timestamp
	10, // 5: gomemo.api.v1.RefreshTokenResponse.expires_at:type_name -> google.protobuf.Timestamp
	0,  // 6: gomemo.api.v1.AuthService.GetCurrentUser:input_type -> gomemo.api.v1.GetCurrentUserRequest
	2,  // 7: gomemo.api.v1.AuthService.SignIn:input_type -> gomemo.api.v1.SignInRequest
	4,  // 8: gomemo.api.v1.AuthService.SignOut:input_type -> gomemo.api.v1.SignOutRequest
	5,  // 9: gomemo.api.v1.AuthService.RefreshToken:input_type -> gomemo.api.v1.RefreshTokenRequest
	1,  // 10: gomemo.api.v1.AuthService.GetCurrentUser:output_type -> gomemo.api.v1.GetCurrentUserResponse
	3,  // 11: gomemo.api.v1.AuthService.SignIn:output_type -> gomemo.api.v1.SignInResponse
	11, // 12: gomemo.api.v1.AuthService.SignOut:output_type -> google.protobuf.Empty
	6,  // 13: gomemo.api.v1.AuthService.RefreshToken:output_type -> gomemo.api.v1.RefreshTokenResponse
