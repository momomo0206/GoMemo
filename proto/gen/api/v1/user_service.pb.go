...
type User struct {
	...
	Role User_Role `protobuf:"varint,2,opt,name=role,proto3,enum=gomemo.api.v1.User_Role" json:"role,omitempty"`
	...
	State State `protobuf:"varint,9,opt,name=state,proto3,enum=gomemo.api.v1.State" json:"state,omitempty"`
...
type CreateUserRequest struct {
	...
	// requests to create a user have the same results.
...
type UserStats struct {
	...
	// Format: users/{user}
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// The timestamps when the memos were desplayed.
...
type UserNotification struct {
	...
	Status UserNotification_Status `protobuf:"varint,3,opt,name=status,proto3,enum=gomemo.api.v1.UserNotification_Status" json:"status,omitempty"`
	// The creation timestamp.
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// The type of the notification.
	Type UserNotification_Type `protobuf:"varint,5,opt,name=type,proto3,enum=gomemo.api.v1.UserNotification_Type" json:"type,omitempty"`
...
const file_api_v1_user_service_proto_rawDesc = "" +
	"\n" +
	"\x19api/v1/user_service.proto\x12\rgomemo.api.v1\x1a\x13api/v1/common.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc4\x04\n" +
	"\x04User\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x121\n" +
	"\x04role\x18\x02 \x01(\x0e2\x18.gomemo.api.v1.User.RoleB\x03\xe0A\x02R\x04role\x12\x1f\n" +
	...
	"\x05state\x18\t \x01(\x0e2\x14.gomemo.api.v1.StateB\x03\xe0A\x02R\x05state\x12@\n" +
	"\vcreate_time\x18\n" +
	...
	"\x04USER\x10\x03:8\xeaA5\n" +
	"\x12gomemo.api.v1/User\x12\fusers/{user}\x1a\x04name*\x05users2\x04user\"\x9d\x01\n" +
	...
	"\x05users\x18\x01 \x03(\v2\x13.gomemo.api.v1.UserR\x05users\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"~\n" +
	"\x0eGetUserRequest\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\x04name\x12<\n" +
	"\tread_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\breadMask\"\xb0\x01\n" +
	"\x11CreateUserRequest\x12/\n" +
	"\x04user\x18\x01 \x01(\v2\x13.gomemo.api.v1.UserB\x06\xe0A\x02\xe0A\x04R\x04user\x12\x1c\n" +
	"\auser_id\x18\x02 \x01(\tB\x03\xe0A\x01R\x06userId\x12(\n" +
	"\rvalidate_only\x18\x03 \x01(\bB\x03\xe0A\x01R\fvalidateOnly\x12\"\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tB\x03\xe0A\x01R\trequestId\"\xad\x01\n" +
	"\x11UpdateUserRequest\x12,\n" +
	"\x04user\x18\x01 \x01(\v2\x13.gomemo.api.v1.UserB\x03\xe0A\x02R\x04user\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\x12(\n" +
	"\rallow_missing\x18\x03 \x01(\bB\x03\xe0A\x01R\fallowMissing\"^\n" +
	"\x11DeleteUserRequest\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\x04name\x12\x19\n" +
	"\x05force\x18\x02 \x01(\bB\x03\xe0A\x01R\x05force\"\xe7\x04\n" +
	"\tUserStats\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12R\n" +
	"\x17memo_display_timestamps\x18\x02 \x03(\v2\x1a.google.protobuf.TimestampR\x15memoDisplayTimestamps\x12N\n" +
	"\x0fmemo_type_stats\x18\x03 \x01(\v2&.gomemo.api.v1.UserStats.MemoTypeStatsR\rmemoTypeStats\x12C\n" +
	"\ttag_count\x18\x04 \x03(\v2&.gomemo.api.v1.UserStats.TagCountEntryR\btagCount\x12!\n" +
	...
	"\x17gomemo.api.v1/UserStats\x12\fusers/{user}*\tuserStats2\tuserStats\"E\n" +
	"\x13GetUserStatsRequest\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\x04name\"\x19\n" +
	"\x17ListAllUserStatsRequest\"J\n" +
	"\x18ListAllUserStatsResponse\x12.\n" +
	"\x05stats\x18\x01 \x03(\v2\x18.gomemo.api.v1.UserStatsR\x05stats\"\xb4\x04\n" +
	"\vUserSetting\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12T\n" +
	"\x0fgeneral_setting\x18\x02 \x01(\v2).gomemo.api.v1.UserSetting.GeneralSettingH\x00R\x0egeneralSetting\x12W\n" +
	"\x10webhooks_setting\x18\x05 \x01(\v2*.gomemo.api.v1.UserSetting.WebhooksSettingH\x00R\x0fwebhooksSetting\x1av\n" +
	...
	"\x05theme\x18\x04 \x01(\tB\x03\xe0A\x01R\x05theme\x1aI\n" +
	"\x0fWebhooksSetting\x126\n" +
	"\bwebhooks\x18\x01 \x03(\v2\x1a.gomemo.api.v1.UserWebhookR\bwebhooks\"5\n" +
	"\x03Key\x12\x13\n" +
	"\x0fKEY_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aGENERAL\x10\x01\x12\f\n" +
	"\bWEBHOOKS\x10\x04:Z\xeaAW\n" +
	"\x19gomemo.api.v1/UserSetting\x12\x1fusers/{user}/settings/{setting}*\fuserSettings2\vuserSettingB\a\n" +
	"\x05value\"N\n" +
	"\x15GetUserSettingRequest\x125\n" +
	"\x04name\x18\x01 \x01(\tB!\xe0A\x02\xfaA\x1b\n" +
	"\x19gomemo.api.v1/UserSettingR\x04name\"\x97\x01\n" +
	"\x18UpdateUserSettingRequest\x129\n" +
	"\asetting\x18\x01 \x01(\v2\x1a.gomemo.api.v1.UserSettingB\x03\xe0A\x02R\asetting\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"\x93\x01\n" +
	"\x17ListUserSettingsRequest\x122\n" +
	"\x06parent\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\x06parent\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\"\x99\x01\n" +
	"\x18ListUserSettingsResponse\x126\n" +
	"\bsettings\x18\x01 \x03(\v2\x1a.gomemo.api.v1.UserSettingR\bsettings\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"\xa8\x03\n" +
	...
	"lastUsedAt:\x8d\x01\xeaA\x89\x01\n" +
	"!gomemo.api.v1/PersonalAccessToken\x129users/{user}/personalAccessTokens/{personal_access_token}*\x14personalAccessTokens2\x13personalAccessToken\"\x9b\x01\n" +
	"\x1fListPersonalAccessTokensRequest\x122\n" +
	"\x06parent\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\x06parent\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\"\xc3\x01\n" +
	" ListPersonalAccessTokensResponse\x12X\n" +
	"\x16personal_access_tokens\x18\x01 \x03(\v2\".gomemo.api.v1.PersonalAccessTokenR\x14personalAccessTokens\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"\xaa\x01\n" +
	" CreatePersonalAccessTokenRequest\x122\n" +
	"\x06parent\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\x06parent\x12%\n" +
	"\vdescription\x18\x02 \x01(\tB\x03\xe0A\x01R\vdescription\x12+\n" +
	"\x0fexpires_in_days\x18\x03 \x01(\x05B\x03\xe0A\x01R\rexpiresInDays\"\x91\x01\n" +
	"!CreatePersonalAccessTokenResponse\x12V\n" +
	"\x15personal_access_token\x18\x01 \x01(\v2\".gomemo.api.v1.PersonalAccessTokenR\x13personalAccessToken\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\"a\n" +
	" DeletePersonalAccessTokenRequest\x12=\n" +
	"\x04name\x18\x01 \x01(\tB)\xe0A\x02\xfaA#\n" +
	"!gomemo.api.v1/PersonalAccessTokenR\x04name\"\xda\x01\n" +
	...
	"\x18ListUserWebhooksResponse\x126\n" +
	"\bwebhooks\x18\x01 \x03(\v2\x1a.gomemo.api.v1.UserWebhookR\bwebhooks\"r\n" +
	"\x18CreateUserWebhookRequest\x12\x1b\n" +
	"\x06parent\x18\x01 \x01(\tB\x03\xe0A\x02R\x06parent\x129\n" +
	"\awebhook\x18\x02 \x01(\v2\x1a.gomemo.api.v1.UserWebhookB\x03\xe0A\x02R\awebhook\"\x92\x01\n" +
	"\x18UpdateUserWebhookRequest\x129\n" +
	"\awebhook\x18\x01 \x01(\v2\x1a.gomemo.api.v1.UserWebhookB\x03\xe0A\x02R\awebhook\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"3\n" +
	"\x18DeleteUserWebhookRequest\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\"\xc1\x04\n" +
	"\x10UserNotification\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xe0A\x03\xe0A\bR\x04name\x122\n" +
	"\x06sender\x18\x02 \x01(\tB\x1a\xe0A\x03\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\x06sender\x12C\n" +
	"\x06status\x18\x03 \x01(\x0e2&.gomemo.api.v1.UserNotification.StatusB\x03\xe0A\x01R\x06status\x12@\n" +
	"\vcreate_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime\x12=\n" +
	"\x04type\x18\x05 \x01(\x0e2$.gomemo.api.v1.UserNotification.TypeB\x03\xe0A\x03R\x04type\x12)\n" +
	...
	"\x1egomemo.api.v1/UserNotification\x12(users/{user}notifications/{notification}\x1a\x04name*\rnotifications2\fnotificationB\x0e\n" +
	"\f_activity_id\"\xb5\x01\n" +
	"\x1cListUserNotificationsRequest\x122\n" +
	"\x06parent\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\x06parent\x12 \n" +
	"\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tB\x03\xe0A\x01R\tpageToken\x12\x1b\n" +
	"\x06filter\x18\x04 \x01(\tB\x03\xe0A\x01R\x06filter\"\x8e\x01\n" +
	"\x1dListUserNotificationsResponse\x12E\n" +
	"\rnotifications\x18\x01 \x03(\v2\x1f.gomemo.api.v1.UserNotificationR\rnotifications\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xab\x01\n" +
	"\x1dUpdateUserNotificationRequest\x12H\n" +
	"\fnotification\x18\x01 \x01(\v2\x1f.gomemo.api.v1.UserNotificationB\x03\xe0A\x02R\fnotification\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"[\n" +
	"\x1dDeleteUserNotificationRequest\x12:\n" +
	"\x04name\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1egomemo.api.v1/UserNotificationR\x04name2\xa9\x17\n" +
	"\vUserService\x12e\n" +
	"\tListUsers\x12\x1f.gomemo.api.v1.ListUsersRequest\x1a .gomemo.api.v1.ListUsersResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/api/v1/users\x12d\n" +
	"\aGetUser\x12\x1d.gomemo.api.v1.GetUserRequest\x1a\x13.gomemo.api.v1.User\"%\xdaA\x04name\x82\xd3\xe4\x93\x02\x18\x12\x16/api/v1/{name=users/*}\x12g\n" +
	"\n" +
	"CreateUser\x12 .gomemo.api.v1.CreateUserRequest\x1a\x13.gomemo.api.v1.User\"\"\xdaA\x04user\x82\xd3\xe4\x93\x02\x15:\x04user\"\r/api/v1/users\x12\x81\x01\n" +
	"\n" +
	"UpdateUser\x12 .gomemo.api.v1.UpdateUserRequest\x1a\x13.gomemo.api.v1.User\"<\xdaA\x10user,update_mask\x82\xd3\xe4\x93\x02#:\x04user2\x1b/api/v1/{user.name=users/*}\x12m\n" +
	"\n" +
	"DeleteUser\x12 .gomemo.api.v1.DeleteUserRequest\x1a\x16.google.protobuf.Empty\"%\xdaA\x04name\x82\xd3\xe4\x93\x02\x18*\x16/api/v1/{name=users/*}\x12\x80\x01\n" +
	"\x10ListAllUserStats\x12&.gomemo.api.v1.ListAllUserStatsRequest\x1a'.gomemo.api.v1.ListAllUserStatsResponse\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/api/v1/users:stats\x12|\n" +
	"\fGetUserStats\x12\".gomemo.api.v1.GetUserStatsRequest\x1a\x18.gomemo.api.v1.UserStats\".\xdaA\x04name\x82\xd3\xe4\x93\x02!\x12\x1f/api/v1/{name=users/*}:getStats\x12\x84\x01\n" +
	"\x0eGetUserSetting\x12$.gomemo.api.v1.GetUserSettingRequest\x1a\x1a.gomemo.api.v1.UserSetting\"0\xdaA\x04name\x82\xd3\xe4\x93\x02#\x12!/api/v1/{name=users/*/settings/*}\x12\xaa\x01\n" +
	"\x11UpdateUserSetting\x12'.gomemo.api.v1.UpdateUserSettingRequest\x1a\x1a.gomemo.api.v1.UserSetting\"P\xdaA\x13setting,update_mask\x82\xd3\xe4\x93\x024:\asetting2)/api/v1/{setting.name=users/*/settings/*}\x12\x97\x01\n" +
	"\x10ListUserSettings\x12&.gomemo.api.v1.ListUserSettingsRequest\x1a'.gomemo.api.v1.ListUserSettingsResponse\"2\xdaA\x06parent\x82\xd3\xe4\x93\x02#\x12!/api/v1/{parent=users/*}/settings\x12\xbb\x01\n" +
	"\x18ListPersonalAccessTokens\x12..gomemo.api.v1.ListPersonalAccessTokensRequest\x1a/.gomemo.api.v1.ListPersonalAccessTokensResponse\">\xdaA\x06parent\x82\xd3\xe4\x93\x02/\x12-/api/v1/{parent=users/*}/personalAccessTokens\x12\xb8\x01\n" +
	"\x19CreatePersonalAccessToken\x12/.gomemo.api.v1.CreatePersonalAccessTokenRequest\x1a0.gomemo.api.v1.CreatePersonalAccessTokenResponse\"8\x82\xd3\xe4\x93\x022:\x01*\"-/api/v1/{parent=users/*}/personalAccessTokens\x12\xa2\x01\n" +
	"\x19DeletePersonalAccessToken\x12/.gomemo.api.v1.DeletePersonalAccessTokenRequest\x1a\x16.google.protobuf.Empty\"<\xdaA\x04name\x82\xd3\xe4\x93\x02/*-/api/v1/{name=users/*/personalAccessTokens/*}\x12\x97\x01\n" +
	"\x10ListUserWebhooks\x12&.gomemo.api.v1.ListUserWebhooksRequest\x1a'.gomemo.api.v1.ListUserWebhooksResponse\"2\xdaA\x06parent\x82\xd3\xe4\x93\x02#\x12!/api/v1/{parent=users/*}/webhooks\x12\x9d\x01\n" +
	"\x11CreateUserWebhook\x12'.gomemo.api.v1.CreateUserWebhookRequest\x1a\x1a.gomemo.api.v1.UserWebhook\"C\xdaA\x0eparent,webhook\x82\xd3\xe4\x93\x02,:\awebhook\"!/api/v1/{parent=users/*}/webhooks\x12\xaa\x01\n" +
	"\x11UpdateUserWebhook\x12'.gomemo.api.v1.UpdateUserWebhookRequest\x1a\x1a.gomemo.api.v1.UserWebhook\"P\xdaA\x13webhook,update_mask\x82\xd3\xe4\x93\x024:\awebhook2)/api/v1/{webhook.name=users/*/webhooks/*}\x12\x86\x01\n" +
	"\x11DeleteUserWebhook\x12'.gomemo.api.v1.DeleteUserWebhookRequest\x1a\x16.google.protobuf.Empty\"0\xdaA\x04name\x82\xd3\xe4\x93\x02#*!/api/v1/{name=users/*/webhooks/*}\x12\xab\x01\n" +
	"\x15ListUserNotifications\x12+.gomemo.api.v1.ListUserNotificationsRequest\x1a,.gomemo.api.v1.ListUserNotificationsResponse\"7\xdaA\x06parent\x82\xd3\xe4\x93\x02(\x12&/api/v1/{parent=users/*}/notifications\x12\xcd\x01\n" +
	"\x16UpdateUserNotification\x12,.gomemo.api.v1.UpdateUserNotificationRequest\x1a\x1f.gomemo.api.v1.UserNotification\"d\xdaA\x18notification,update_mask\x82\xd3\xe4\x93\x02C:\fnotification23/api/v1/{notification.name=users/*/notifications/*}\x12\x95\x01\n" +
	"\x16DeleteUserNotification\x12,.gomemo.api.v1.DeleteUserNotificationRequest\x1a\x16.google.protobuf.Empty\"5\xdaA\x04name\x82\xd3\xe4\x93\x02(*&/api/v1/{name=users/*/notifications/*}B\xb0\x01\n" +
	"\x11com.gomemo.api.v1B\x10UserServiceProtoP\x01Z3github.com/momomo0206/gomemo/proto/gen/api/v1;apiv1\xa2\x02\x03GAX\xaa\x02\rGomemo.Api.V1\xca\x02\rGomemo\\Api\\V1\xe2\x02\x19Gomemo\\Api\\V1\\GPBMetadata\xea\x02\x0fGomemo::Api::V1b\x06proto3"
...
var file_api_v1_user_service_proto_goTypes = []any{
	(User_Role)(0),                            // 0: gomemo.api.v1.User.Role
	(UserSetting_Key)(0),                      // 1: gomemo.api.v1.UserSetting.Key
	(UserNotification_Status)(0),              // 2: gomemo.api.v1.UserNotification.Status
	(UserNotification_Type)(0),                // 3: gomemo.api.v1.UserNotification.Type
	(*User)(nil),                              // 4: gomemo.api.v1.User
	(*ListUsersRequest)(nil),                  // 5: gomemo.api.v1.ListUsersRequest
	(*ListUsersResponse)(nil),                 // 6: gomemo.api.v1.ListUsersResponse
	(*GetUserRequest)(nil),                    // 7: gomemo.api.v1.GetUserRequest
	(*CreateUserRequest)(nil),                 // 8: gomemo.api.v1.CreateUserRequest
	(*UpdateUserRequest)(nil),                 // 9: gomemo.api.v1.UpdateUserRequest
	(*DeleteUserRequest)(nil),                 // 10: gomemo.api.v1.DeleteUserRequest
	(*UserStats)(nil),                         // 11: gomemo.api.v1.UserStats
	(*GetUserStatsRequest)(nil),               // 12: gomemo.api.v1.GetUserStatsRequest
	(*ListAllUserStatsRequest)(nil),           // 13: gomemo.api.v1.ListAllUserStatsRequest
	(*ListAllUserStatsResponse)(nil),          // 14: gomemo.api.v1.ListAllUserStatsResponse
	(*UserSetting)(nil),                       // 15: gomemo.api.v1.UserSetting
	(*GetUserSettingRequest)(nil),             // 16: gomemo.api.v1.GetUserSettingRequest
	(*UpdateUserSettingRequest)(nil),          // 17: gomemo.api.v1.UpdateUserSettingRequest
	(*ListUserSettingsRequest)(nil),           // 18: gomemo.api.v1.ListUserSettingsRequest
	(*ListUserSettingsResponse)(nil),          // 19: gomemo.api.v1.ListUserSettingsResponse
	(*PersonalAccessToken)(nil),               // 20: gomemo.api.v1.PersonalAccessToken
	(*ListPersonalAccessTokensRequest)(nil),   // 21: gomemo.api.v1.ListPersonalAccessTokensRequest
	(*ListPersonalAccessTokensResponse)(nil),  // 22: gomemo.api.v1.ListPersonalAccessTokensResponse
	(*CreatePersonalAccessTokenRequest)(nil),  // 23: gomemo.api.v1.CreatePersonalAccessTokenRequest
	(*CreatePersonalAccessTokenResponse)(nil), // 24: gomemo.api.v1.CreatePersonalAccessTokenResponse
	(*DeletePersonalAccessTokenRequest)(nil),  // 25: gomemo.api.v1.DeletePersonalAccessTokenRequest
	(*UserWebhook)(nil),                       // 26: gomemo.api.v1.UserWebhook
	(*ListUserWebhooksRequest)(nil),           // 27: gomemo.api.v1.ListUserWebhooksRequest
	(*ListUserWebhooksResponse)(nil),          // 28: gomemo.api.v1.ListUserWebhooksResponse
	(*CreateUserWebhookRequest)(nil),          // 29: gomemo.api.v1.CreateUserWebhookRequest
	(*UpdateUserWebhookRequest)(nil),          // 30: gomemo.api.v1.UpdateUserWebhookRequest
	(*DeleteUserWebhookRequest)(nil),          // 31: gomemo.api.v1.DeleteUserWebhookRequest
	(*UserNotification)(nil),                  // 32: gomemo.api.v1.UserNotification
	(*ListUserNotificationsRequest)(nil),      // 33: gomemo.api.v1.ListUserNotificationsRequest
	(*ListUserNotificationsResponse)(nil),     // 34: gomemo.api.v1.ListUserNotificationsResponse
	(*UpdateUserNotificationRequest)(nil),     // 35: gomemo.api.v1.UpdateUserNotificationRequest
	(*DeleteUserNotificationRequest)(nil),     // 36: gomemo.api.v1.DeleteUserNotificationRequest
	nil,                                       // 37: gomemo.api.v1.UserStats.TagCountEntry
	(*UserStats_MemoTypeStats)(nil),           // 38: gomemo.api.v1.UserStats.MemoTypeStats
	(*UserSetting_GeneralSetting)(nil),        // 39: gomemo.api.v1.UserSetting.GeneralSetting
	(*UserSetting_WebhooksSetting)(nil),       // 40: gomemo.api.v1.UserSetting.WebhooksSetting
	(State)(0),                                // 41: gomemo.api.v1.State
	(*timestamppb.Timestamp)(nil),             // 42: google.protobuf.Timestamp
	(*fieldmaskpb.FieldMask)(nil),             // 43: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                     // 44: google.protobuf.Empty
}
var file_api_v1_user_service_proto_depIdxs = []int32{
	0,  // 0: gomemo.api.v1.User.role:type_name -> gomemo.api.v1.User.Role
	41, // 1: gomemo.api.v1.User.state:type_name -> gomemo.api.v1.State
	42, // 2: gomemo.api.v1.User.create_time:type_name -> google.protobuf.Timestamp
	42, // 3: gomemo.api.v1.User.update_time:type_name -> google.protobuf.Timestamp
	4,  // 4: gomemo.api.v1.ListUsersResponse.users:type_name -> gomemo.api.v1.User
	43, // 5: gomemo.api.v1.GetUserRequest.read_mask:type_name -> google.protobuf.FieldMask
	4,  // 6: gomemo.api.v1.CreateUserRequest.user:type_name -> gomemo.api.v1.User
	4,  // 7: gomemo.api.v1.UpdateUserRequest.user:type_name -> gomemo.api.v1.User
	43, // 8: gomemo.api.v1.UpdateUserRequest.update_mask:type_name -> google.protobuf.FieldMask
	42, // 9: gomemo.api.v1.UserStats.memo_display_timestamps:type_name -> google.protobuf.Timestamp
	38, // 10: gomemo.api.v1.UserStats.memo_type_stats:type_name -> gomemo.api.v1.UserStats.MemoTypeStats
	37, // 11: gomemo.api.v1.UserStats.tag_count:type_name -> gomemo.api.v1.UserStats.TagCountEntry
	11, // 12: gomemo.api.v1.ListAllUserStatsResponse.stats:type_name -> gomemo.api.v1.UserStats
	39, // 13: gomemo.api.v1.UserSetting.general_setting:type_name -> gomemo.api.v1.UserSetting.GeneralSetting
	40, // 14: gomemo.api.v1.UserSetting.webhooks_setting:type_name -> gomemo.api.v1.UserSetting.WebhooksSetting
	15, // 15: gomemo.api.v1.UpdateUserSettingRequest.setting:type_name -> gomemo.api.v1.UserSetting
	43, // 16: gomemo.api.v1.UpdateUserSettingRequest.update_mask:type_name -> google.protobuf.FieldMask
	15, // 17: gomemo.api.v1.ListUserSettingsResponse.settings:type_name -> gomemo.api.v1.UserSetting
	42, // 18: gomemo.api.v1.PersonalAccessToken.created_at:type_name -> google.protobuf.Timestamp
	42, // 19: gomemo.api.v1.PersonalAccessToken.expires_at:type_name -> google.protobuf.Timestamp
	42, // 20: gomemo.api.v1.PersonalAccessToken.last_used_at:type_name -> google.protobuf.Timestamp
	20, // 21: gomemo.api.v1.ListPersonalAccessTokensResponse.personal_access_tokens:type_name -> gomemo.api.v1.PersonalAccessToken
	20, // 22: gomemo.api.v1.CreatePersonalAccessTokenResponse.personal_access_token:type_name -> gomemo.api.v1.PersonalAccessToken
	42, // 23: gomemo.api.v1.UserWebhook.create_time:type_name -> google.protobuf.Timestamp
	42, // 24: gomemo.api.v1.UserWebhook.update_time:type_name -> google.protobuf.Timestamp
	26, // 25: gomemo.api.v1.ListUserWebhooksResponse.webhooks:type_name -> gomemo.api.v1.UserWebhook
	26, // 26: gomemo.api.v1.CreateUserWebhookRequest.webhook:type_name -> gomemo.api.v1.UserWebhook
	26, // 27: gomemo.api.v1.UpdateUserWebhookRequest.webhook:type_name -> gomemo.api.v1.UserWebhook
	43, // 28: gomemo.api.v1.UpdateUserWebhookRequest.update_mask:type_name -> google.protobuf.FieldMask
	2,  // 29: gomemo.api.v1.UserNotification.status:type_name -> gomemo.api.v1.UserNotification.Status
	42, // 30: gomemo.api.v1.UserNotification.create_time:type_name -> google.protobuf.Timestamp
	3,  // 31: gomemo.api.v1.UserNotification.type:type_name -> gomemo.api.v1.UserNotification.Type
	32, // 32: gomemo.api.v1.ListUserNotificationsResponse.notifications:type_name -> gomemo.api.v1.UserNotification
	32, // 33: gomemo.api.v1.UpdateUserNotificationRequest.notification:type_name -> gomemo.api.v1.UserNotification
	43, // 34: gomemo.api.v1.UpdateUserNotificationRequest.update_mask:type_name -> google.protobuf.FieldMask
	26, // 35: gomemo.api.v1.UserSetting.WebhooksSetting.webhooks:type_name -> gomemo.api.v1.UserWebhook
	5,  // 36: gomemo.api.v1.UserService.ListUsers:input_type -> gomemo.api.v1.ListUsersRequest
	7,  // 37: gomemo.api.v1.UserService.GetUser:input_type -> gomemo.api.v1.GetUserRequest
	8,  // 38: gomemo.api.v1.UserService.CreateUser:input_type -> gomemo.api.v1.CreateUserRequest
	9,  // 39: gomemo.api.v1.UserService.UpdateUser:input_type -> gomemo.api.v1.UpdateUserRequest
	10, // 40: gomemo.api.v1.UserService.DeleteUser:input_type -> gomemo.api.v1.DeleteUserRequest
	13, // 41: gomemo.api.v1.UserService.ListAllUserStats:input_type -> gomemo.api.v1.ListAllUserStatsRequest
	12, // 42: gomemo.api.v1.UserService.GetUserStats:input_type -> gomemo.api.v1.GetUserStatsRequest
	16, // 43: gomemo.api.v1.UserService.GetUserSetting:input_type -> gomemo.api.v1.GetUserSettingRequest
	17, // 44: gomemo.api.v1.UserService.UpdateUserSetting:input_type -> gomemo.api.v1.UpdateUserSettingRequest
	18, // 45: gomemo.api.v1.UserService.ListUserSettings:input_type -> gomemo.api.v1.ListUserSettingsRequest
	21, // 46: gomemo.api.v1.UserService.ListPersonalAccessTokens:input_type -> gomemo.api.v1.ListPersonalAccessTokensRequest
	23, // 47: gomemo.api.v1.UserService.CreatePersonalAccessToken:input_type -> gomemo.api.v1.CreatePersonalAccessTokenRequest
	25, // 48: gomemo.api.v1.UserService.DeletePersonalAccessToken:input_type -> gomemo.api.v1.DeletePersonalAccessTokenRequest
	27, // 49: gomemo.api.v1.UserService.ListUserWebhooks:input_type -> gomemo.api.v1.ListUserWebhooksRequest
	29, // 50: gomemo.api.v1.UserService.CreateUserWebhook:input_type -> gomemo.api.v1.CreateUserWebhookRequest
	30, // 51: gomemo.api.v1.UserService.UpdateUserWebhook:input_type -> gomemo.api.v1.UpdateUserWebhookRequest
	31, // 52: gomemo.api.v1.UserService.DeleteUserWebhook:input_type -> gomemo.api.v1.DeleteUserWebhookRequest
	33, // 53: gomemo.api.v1.UserService.ListUserNotifications:input_type -> gomemo.api.v1.ListUserNotificationsRequest
	35, // 54: gomemo.api.v1.UserService.UpdateUserNotification:input_type -> gomemo.api.v1.UpdateUserNotificationRequest
	36, // 55: gomemo.api.v1.UserService.DeleteUserNotification:input_type -> gomemo.api.v1.DeleteUserNotificationRequest
	6,  // 56: gomemo.api.v1.UserService.ListUsers:output_type -> gomemo.api.v1.ListUsersResponse
	4,  // 57: gomemo.api.v1.UserService.GetUser:output_type -> gomemo.api.v1.User
	4,  // 58: gomemo.api.v1.UserService.CreateUser:output_type -> gomemo.api.v1.User
	4,  // 59: gomemo.api.v1.UserService.UpdateUser:output_type -> gomemo.api.v1.User
	44, // 60: gomemo.api.v1.UserService.DeleteUser:output_type -> google.protobuf.Empty
	14, // 61: gomemo.api.v1.UserService.ListAllUserStats:output_type -> gomemo.api.v1.ListAllUserStatsResponse
	11, // 62: gomemo.api.v1.UserService.GetUserStats:output_type -> gomemo.api.v1.UserStats
	15, // 63: gomemo.api.v1.UserService.GetUserSetting:output_type -> gomemo.api.v1.UserSetting
	15, // 64: gomemo.api.v1.UserService.UpdateUserSetting:output_type -> gomemo.api.v1.UserSetting
	19, // 65: gomemo.api.v1.UserService.ListUserSettings:output_type -> gomemo.api.v1.ListUserSettingsResponse
	22, // 66: gomemo.api.v1.UserService.ListPersonalAccessTokens:output_type -> gomemo.api.v1.ListPersonalAccessTokensResponse
	24, // 67: gomemo.api.v1.UserService.CreatePersonalAccessToken:output_type -> gomemo.api.v1.CreatePersonalAccessTokenResponse
	44, // 68: gomemo.api.v1.UserService.DeletePersonalAccessToken:output_type -> google.protobuf.Empty
	28, // 69: gomemo.api.v1.UserService.ListUserWebhooks:output_type -> gomemo.api.v1.ListUserWebhooksResponse
	26, // 70: gomemo.api.v1.UserService.CreateUserWebhook:output_type -> gomemo.api.v1.UserWebhook
	26, // 71: gomemo.api.v1.UserService.UpdateUserWebhook:output_type -> gomemo.api.v1.UserWebhook
	44, // 72: gomemo.api.v1.UserService.DeleteUserWebhook:output_type -> google.protobuf.Empty
	34, // 73: gomemo.api.v1.UserService.ListUserNotifications:output_type -> gomemo.api.v1.ListUserNotificationsResponse
	32, // 74: gomemo.api.v1.UserService.UpdateUserNotification:output_type -> gomemo.api.v1.UserNotification
	44, // 75: gomemo.api.v1.UserService.DeleteUserNotification:output_type -> google.protobuf.Empty
