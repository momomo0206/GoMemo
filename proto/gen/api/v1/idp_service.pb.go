...
type IdentityProvider struct {
	...
	Type IdentityProvider_Type `protobuf:"varint,2,opt,name=type,proto3,enum=gomemo.api.v1.IdentityProvider_Type" json:"type,omitempty"`
...
const file_api_v1_idp_service_proto_rawDesc = "" +
	"\n" +
	"\x18api/v1/idp_service.proto\x12\rgomemo.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\"\x8f\x03\n" +
	"\x10IdentityProvider\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12=\n" +
	"\x04type\x18\x02 \x01(\x0e2$.gomemo.api.v1.IdentityProvider.TypeB\x03\xe0A\x02R\x04type\x12\x19\n" +
	"\x05title\x18\x03 \x01(\tB\x03\xe0A\x02R\x05title\x120\n" +
	"\x11identifier_filter\x18\x04 \x01(\tB\x03\xe0A\x01R\x10identifierFilter\x12B\n" +
	"\x06config\x18\x05 \x01(\v2%.gomemo.api.v1.IdentityProviderConfigB\x03\xe0A\x02R\x06config\"(\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06OAUTH2\x10\x01:h\xeaAe\n" +
	"\x1egomemo.api.v1/IdentityProvider\x12\x18identity-providers/{idp}\x1a\x04name*\x11identityProviders2\x10identityProvider\"f\n" +
	"\x16IdentityProviderConfig\x12B\n" +
	"\roauth2_config\x18\x01 \x01(\v2\x1b.gomemo.api.v1.OAuth2ConfigH\x00R\foauth2ConfigB\b\n" +
	"\x06config\"\x86\x01\n" +
	...
	"\n" +
	"avatar_url\x18\x04 \x01(\tR\tavatarUrl\"\x86\x02\n" +
	...
	"\rfield_mapping\x18\a \x01(\v2\x1b.gomemo.api.v1.FieldMappingR\ffieldMapping\"\x1e\n" +
	"\x1cListIdentityProvidersRequest\"o\n" +
	"\x1dListIdentityProvidersResponse\x12N\n" +
	"\x12identity_providers\x18\x01 \x03(\v2\x1f.gomemo.api.v1.IdentityProviderR\x11identityProviders\"X\n" +
	"\x1aGetIdentityProviderRequest\x12:\n" +
	"\x04name\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1egomemo.api.v1/IdentityProviderR\x04name\"\xa9\x01\n" +
	"\x1dCreateIdentityProviderRequest\x12Q\n" +
	"\x11identity_provider\x18\x01 \x01(\v2\x1f.gomemo.api.v1.IdentityProviderB\x03\xe0A\x02R\x10identityProvider\x125\n" +
	"\x14identity_provider_id\x18\x02 \x01(\tB\x03\xe0A\x01R\x12identityProviderId\"\xb4\x01\n" +
	"\x1dUpdateIdentityProviderRequest\x12Q\n" +
	"\x11identity_provider\x18\x01 \x01(\v2\x1f.gomemo.api.v1.IdentityProviderB\x03\xe0A\x02R\x10identityProvider\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"[\n" +
	"\x1dDeleteIdentityProviderRequest\x12:\n" +
	"\x04name\x18\x01 \x01(\tB&\xe0A\x02\xfaA \n" +
	"\x1egomemo.api.v1/IdentityProviderR\x04name2\xf0\x06\n" +
	"\x17IdentityProviderService\x12\x96\x01\n" +
	"\x15ListIdentityProviders\x12+.gomemo.api.v1.ListIdentityProvidersRequest\x1a,.gomemo.api.v1.ListIdentityProvidersResponse\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/api/v1/identity-providers\x12\x95\x01\n" +
	"\x13GetIdentityProvider\x12).gomemo.api.v1.GetIdentityProviderRequest\x1a\x1f.gomemo.api.v1.IdentityProvider\"2\xdaA\x04name\x82\xd3\xe4\x93\x02%\x12#/api/v1/{name=identity-providers/*}\x12\xb2\x01\n" +
	"\x16CreateIdentityProvider\x12,.gomemo.api.v1.CreateIdentityProviderRequest\x1a\x1f.gomemo.api.v1.IdentityProvider\"I\xdaA\x11identity_provider\x82\xd3\xe4\x93\x02/:\x11identity_provider\"\x1a/api/v1/identity-providers\x12\xd9\x01\n" +
	"\x16UpdateIdentityProvider\x12,.gomemo.api.v1.UpdateIdentityProviderRequest\x1a\x1f.gomemo.api.v1.IdentityProvider\"p\xdaA\x1didentity_provider,update_mask\x82\xd3\xe4\x93\x02J:\x11identity_provider25/api/v1/{identity_provider.name=identity-providers/*}\x12\x92\x01\n" +
	"\x16DeleteIdentityProvider\x12,.gomemo.api.v1.DeleteIdentityProviderRequest\x1a\x16.google.protobuf.Empty\"2\xdaA\x04name\x82\xd3\xe4\x93\x02%*#/api/v1/{name=identity-providers/*}B\xaf\x01\n" +
	"\x11com.gomemo.api.v1B\x0fIdpServiceProtoP\x01Z3github.com/momomo0206/gomemo/proto/gen/api/v1;apiv1\xa2\x02\x03GAX\xaa\x02\rGomemo.Api.V1\xca\x02\rGomemo\\Api\\V1\xe2\x02\x19Gomemo\\Api\\V1\\GPBMetadata\xea\x02\x0fGomemo::Api::V1b\x06proto3"
...
var file_api_v1_idp_service_proto_goTypes = []any{
	(IdentityProvider_Type)(0),            // 0: gomemo.api.v1.IdentityProvider.Type
	(*IdentityProvider)(nil),              // 1: gomemo.api.v1.IdentityProvider
	(*IdentityProviderConfig)(nil),        // 2: gomemo.api.v1.IdentityProviderConfig
	(*FieldMapping)(nil),                  // 3: gomemo.api.v1.FieldMapping
	(*OAuth2Config)(nil),                  // 4: gomemo.api.v1.OAuth2Config
	(*ListIdentityProvidersRequest)(nil),  // 5: gomemo.api.v1.ListIdentityProvidersRequest
	(*ListIdentityProvidersResponse)(nil), // 6: gomemo.api.v1.ListIdentityProvidersResponse
	(*GetIdentityProviderRequest)(nil),    // 7: gomemo.api.v1.GetIdentityProviderRequest
	(*CreateIdentityProviderRequest)(nil), // 8: gomemo.api.v1.CreateIdentityProviderRequest
	(*UpdateIdentityProviderRequest)(nil), // 9: gomemo.api.v1.UpdateIdentityProviderRequest
	(*DeleteIdentityProviderRequest)(nil), // 10: gomemo.api.v1.DeleteIdentityProviderRequest
	(*fieldmaskpb.FieldMask)(nil),         // 11: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                 // 12: google.protobuf.Empty
}
var file_api_v1_idp_service_proto_depIdxs = []int32{
	0,  // 0: gomemo.api.v1.IdentityProvider.type:type_name -> gomemo.api.v1.IdentityProvider.Type
	2,  // 1: gomemo.api.v1.IdentityProvider.config:type_name -> gomemo.api.v1.IdentityProviderConfig
	4,  // 2: gomemo.api.v1.IdentityProviderConfig.oauth2_config:type_name -> gomemo.api.v1.OAuth2Config
	3,  // 3: gomemo.api.v1.OAuth2Config.field_mapping:type_name -> gomemo.api.v1.FieldMapping
	1,  // 4: gomemo.api.v1.ListIdentityProvidersResponse.identity_providers:type_name -> gomemo.api.v1.IdentityProvider
	1,  // 5: gomemo.api.v1.CreateIdentityProviderRequest.identity_provider:type_name -> gomemo.api.v1.IdentityProvider
	1,  // 6: gomemo.api.v1.UpdateIdentityProviderRequest.identity_provider:type_name -> gomemo.api.v1.IdentityProvider
	11, // 7: gomemo.api.v1.UpdateIdentityProviderRequest.update_mask:type_name -> google.protobuf.FieldMask
	5,  // 8: gomemo.api.v1.IdentityProviderService.ListIdentityProviders:input_type -> gomemo.api.v1.ListIdentityProvidersRequest
	7,  // 9: gomemo.api.v1.IdentityProviderService.GetIdentityProvider:input_type -> gomemo.api.v1.GetIdentityProviderRequest
	8,  // 10: gomemo.api.v1.IdentityProviderService.CreateIdentityProvider:input_type -> gomemo.api.v1.CreateIdentityProviderRequest
	9,  // 11: gomemo.api.v1.IdentityProviderService.UpdateIdentityProvider:input_type -> gomemo.api.v1.UpdateIdentityProviderRequest
	10, // 12: gomemo.api.v1.IdentityProviderService.DeleteIdentityProvider:input_type -> gomemo.api.v1.DeleteIdentityProviderRequest
	6,  // 13: gomemo.api.v1.IdentityProviderService.ListIdentityProviders:output_type -> gomemo.api.v1.ListIdentityProvidersResponse
	1,  // 14: gomemo.api.v1.IdentityProviderService.GetIdentityProvider:output_type -> gomemo.api.v1.IdentityProvider
	1,  // 15: gomemo.api.v1.IdentityProviderService.CreateIdentityProvider:output_type -> gomemo.api.v1.IdentityProvider
	1,  // 16: gomemo.api.v1.IdentityProviderService.UpdateIdentityProvider:output_type -> gomemo.api.v1.IdentityProvider
	12, // 17: gomemo.api.v1.IdentityProviderService.DeleteIdentityProvider:output_type -> google.protobuf.Empty
