...
const file_api_v1_shortcut_service_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/v1/shortcut_service.proto\x12\rgomemo.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\"\xb0\x01\n" +
	"\bShortcut\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12\x19\n" +
	"\x05title\x18\x02 \x01(\tB\x03\xe0A\x02R\x05title\x12\x1b\n" +
	"\x06filter\x18\x03 \x01(\tB\x03\xe0A\x01R\x06filter:S\xeaAP\n" +
	"\x16gomemo.api.v1/Shortcut\x12!users/{user}/shortcuts/{shortcut}*\tshortcuts2\bshortcut\"N\n" +
	"\x14ListShortcutsRequest\x126\n" +
	"\x06parent\x18\x01 \x01(\tB\x1e\xe0A\x02\xfaA\x18\n" +
	"\x16gomemo.api.v1/ShortcutR\x06parent\"N\n" +
	"\x15ListShortcutsResponse\x125\n" +
	"\tshortcuts\x18\x01 \x03(\v2\x17.gomemo.api.v1.ShortcutR\tshortcuts\"H\n" +
	"\x12GetShortcutRequest\x122\n" +
	"\x04name\x18\x01 \x01(\tB\x1e\xe0A\x02\xfaA\x18\n" +
	"\x16gomemo.api.v1/ShortcutR\x04name\"\xb3\x01\n" +
	"\x15CreateShortcutRequest\x126\n" +
	"\x06parent\x18\x01 \x01(\tB\x1e\xe0A\x02\xfaA\x18\n" +
	"\x16gomemo.api.v1/ShortcutR\x06parent\x128\n" +
	"\bshortcut\x18\x02 \x01(\v2\x17.gomemo.api.v1.ShortcutB\x03\xe0A\x02R\bshortcut\x12(\n" +
	"\rvalidate_only\x18\x03 \x01(\bB\x03\xe0A\x01R\fvalidateOnly\"\x93\x01\n" +
	"\x15UpdateShortcutRequest\x128\n" +
	"\bshortcut\x18\x01 \x01(\v2\x17.gomemo.api.v1.ShortcutB\x03\xe0A\x02R\bshortcut\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\n" +
	"updateMask\"K\n" +
	"\x15DeleteShortcutRequest\x122\n" +
	"\x04name\x18\x01 \x01(\tB\x1e\xe0A\x02\xfaA\x18\n" +
	"\x16gomemo.api.v1/ShortcutR\x04name2\xe7\x05\n" +
	"\x0fShortcutService\x12\x8f\x01\n" +
	"\rListShortcuts\x12#.gomemo.api.v1.ListShortcutsRequest\x1a$.gomemo.api.v1.ListShortcutsResponse\"3\xdaA\x06parent\x82\xd3\xe4\x93\x02$\x12\"/api/v1/{parent=users/*}/shortcuts\x12|\n" +
	"\vGetShortcut\x12!.gomemo.api.v1.GetShortcutRequest\x1a\x17.gomemo.api.v1.Shortcut\"1\xdaA\x04name\x82\xd3\xe4\x93\x02$\x12\"/api/v1/{name=users/*/shortcuts/*}\x12\x97\x01\n" +
	"\x0eCreateShortcut\x12$.gomemo.api.v1.CreateShortcutRequest\x1a\x17.gomemo.api.v1.Shortcut\"F\xdaA\x0fparent,shortcut\x82\xd3\xe4\x93\x02.:\bshortcut\"\"/api/v1/{parent=users/*}/shortcuts\x12\xa5\x01\n" +
	"\x0eUpdateShortcut\x12$.gomemo.api.v1.UpdateShortcutRequest\x1a\x17.gomemo.api.v1.Shortcut\"T\xdaA\x14shortcut,update_mask\x82\xd3\xe4\x93\x027:\bshortcut2+/api/v1/{shortcut.name=users/*/shortcuts/*}\x12\x81\x01\n" +
	"\x0eDeleteShortcut\x12$.gomemo.api.v1.DeleteShortcutRequest\x1a\x16.google.protobuf.Empty\"1\xdaA\x04name\x82\xd3\xe4\x93\x02$*\"/api/v1/{name=users/*/shortcuts/*}B\xb4\x01\n" +
	"\x11com.gomemo.api.v1B\x14ShortcutServiceProtoP\x01Z3github.com/momomo0206/gomemo/proto/gen/api/v1;apiv1\xa2\x02\x03GAX\xaa\x02\rGomemo.Api.V1\xca\x02\rGomemo\\Api\\V1\xe2\x02\x19Gomemo\\Api\\V1\\GPBMetadata\xea\x02\x0fGomemo::Api::V1b\x06proto3"
...
var file_api_v1_shortcut_service_proto_goTypes = []any{
	(*Shortcut)(nil),              // 0: gomemo.api.v1.Shortcut
	(*ListShortcutsRequest)(nil),  // 1: gomemo.api.v1.ListShortcutsRequest
	(*ListShortcutsResponse)(nil), // 2: gomemo.api.v1.ListShortcutsResponse
	(*GetShortcutRequest)(nil),    // 3: gomemo.api.v1.GetShortcutRequest
	(*CreateShortcutRequest)(nil), // 4: gomemo.api.v1.CreateShortcutRequest
	(*UpdateShortcutRequest)(nil), // 5: gomemo.api.v1.UpdateShortcutRequest
	(*DeleteShortcutRequest)(nil), // 6: gomemo.api.v1.DeleteShortcutRequest
	(*fieldmaskpb.FieldMask)(nil), // 7: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),         // 8: google.protobuf.Empty
}
var file_api_v1_shortcut_service_proto_depIdxs = []int32{
	0, // 0: gomemo.api.v1.ListShortcutsResponse.shortcuts:type_name -> gomemo.api.v1.Shortcut
	0, // 1: gomemo.api.v1.CreateShortcutRequest.shortcut:type_name -> gomemo.api.v1.Shortcut
	0, // 2: gomemo.api.v1.UpdateShortcutRequest.shortcut:type_name -> gomemo.api.v1.Shortcut
	7, // 3: gomemo.api.v1.UpdateShortcutRequest.update_mask:type_name -> google.protobuf.FieldMask
	1, // 4: gomemo.api.v1.ShortcutService.ListShortcuts:input_type -> gomemo.api.v1.ListShortcutsRequest
	3, // 5: gomemo.api.v1.ShortcutService.GetShortcut:input_type -> gomemo.api.v1.GetShortcutRequest
	4, // 6: gomemo.api.v1.ShortcutService.CreateShortcut:input_type -> gomemo.api.v1.CreateShortcutRequest
	5, // 7: gomemo.api.v1.ShortcutService.UpdateShortcut:input_type -> gomemo.api.v1.UpdateShortcutRequest
	6, // 8: gomemo.api.v1.ShortcutService.DeleteShortcut:input_type -> gomemo.api.v1.DeleteShortcutRequest
	2, // 9: gomemo.api.v1.ShortcutService.ListShortcuts:output_type -> gomemo.api.v1.ListShortcutsResponse
	0, // 10: gomemo.api.v1.ShortcutService.GetShortcut:output_type -> gomemo.api.v1.Shortcut
	0, // 11: gomemo.api.v1.ShortcutService.CreateShortcut:output_type -> gomemo.api.v1.Shortcut
	0, // 12: gomemo.api.v1.ShortcutService.UpdateShortcut:output_type -> gomemo.api.v1.Shortcut
	8, // 13: gomemo.api.v1.ShortcutService.DeleteShortcut:output_type -> google.protobuf.Empty
