...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/momomo0206/gomemo/proto/gen/api/v1"
...
const (
	...
	UserServiceName = "gomemo.api.v1.UserService"
)
...
const (
	...
	UserServiceListUsersProcedure = "/gomemo.api.v1.UserService/ListUsers"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/gomemo.api.v1.UserService/GetUser"
	// UserServiceCreateUserProcedure is the fully-qualified name of the UserService's CreateUser RPC.
	UserServiceCreateUserProcedure = "/gomemo.api.v1.UserService/CreateUser"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/gomemo.api.v1.UserService/UpdateUser"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/gomemo.api.v1.UserService/DeleteUser"
	// UserServiceListAllUserStatsProcedure is the fully-qualified name of the UserService's
	// ListAllUserStats RPC.
	UserServiceListAllUserStatsProcedure = "/gomemo.api.v1.UserService/ListAllUserStats"
	// UserServiceGetUserStatsProcedure is the fully-qualified name of the UserService's GetUserStats
	// RPC.
	UserServiceGetUserStatsProcedure = "/gomemo.api.v1.UserService/GetUserStats"
	// UserServiceGetUserSettingProcedure is the fully-qualified name of the UserService's
	// GetUserSetting RPC.
	UserServiceGetUserSettingProcedure = "/gomemo.api.v1.UserService/GetUserSetting"
	// UserServiceUpdateUserSettingProcedure is the fully-qualified name of the UserService's
	// UpdateUserSetting RPC.
	UserServiceUpdateUserSettingProcedure = "/gomemo.api.v1.UserService/UpdateUserSetting"
	// UserServiceListUserSettingsProcedure is the fully-qualified name of the UserService's
	// ListUserSettings RPC.
	UserServiceListUserSettingsProcedure = "/gomemo.api.v1.UserService/ListUserSettings"
	...
	UserServiceListPersonalAccessTokensProcedure = "/gomemo.api.v1.UserService/ListPersonalAccessTokens"
	...
	UserServiceCreatePersonalAccessTokenProcedure = "/gomemo.api.v1.UserService/CreatePersonalAccessToken"
...
type UserServiceClient interface {
	...
	// ListUserNotification lists notifications for a user.
...
// NewUserServiceClient constructs a client for the gomemo.api.v1.UserService service. By default,
...
// ListUsers calls gomemo.api.v1.UserService.ListUsers.
...
// GetUser calls gomemo.api.v1.UserService.GetUser.
...
// CreateUser calls gomemo.api.v1.UserService.CreateUser.
...
// UpdateUser calls gomemo.api.v1.UserService.UpdateUser.
...
// DeleteUser calls gomemo.api.v1.UserService.DeleteUser.
...
// ListAllUserStats calls gomemo.api.v1.UserService.ListAllUserStats.
...
// GetUserStats calls gomemo.api.v1.UserService.GetUserStats.
...
// GetUserSetting calls gomemo.api.v1.UserService.GetUserSetting.
...
// UpdateUserSetting calls gomemo.api.v1.UserService.UpdateUserSetting.
...
// ListUserSettings calls gomemo.api.v1.UserService.ListUserSettings.
...
// ListPersonalAccessTokens calls gomemo.api.v1.UserService.ListPersonalAccessTokens.
...
// CreatePersonalAccessToken calls gomemo.api.v1.UserService.CreatePersonalAccessToken.
...
// DeletePersonalAccessToken calls gomemo.api.v1.UserService.DeletePersonalAccessToken.
...
// ListUserWebhooks calls gomemo.api.v1.UserService.ListUserWebhooks.
...
// CreateUserWebhook calls gomemo.api.v1.UserService.CreateUserWebhook.
...
// UpdateUserWebhook calls gomemo.api.v1.UserService.UpdateUserWebhook.
...
// DeleteUserWebhook calls gomemo.api.v1.UserService.DeleteUserWebhook.
...
// ListUserNotifications calls gomemo.api.v1.UserService.ListUserNotifications.
...
// UpdateUserNotification calls gomemo.api.v1.UserService.UpdateUserNotification.
...
// DeleteUserNotification calls gomemo.api.v1.UserService.DeleteUserNotification.
...
// UserServiceHandler is an implementation of the gomemo.api.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gomemo.api.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[v1.DeleteUserRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.DeleteUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListAllUserStats(context.Context, *connect.Request[v1.ListAllUserStatsRequest]) (*connect.Response[v1.ListAllUserStatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.ListAllUserStats is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUserStats(context.Context, *connect.Request[v1.GetUserStatsRequest]) (*connect.Response[v1.UserStats], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.GetUserStats is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUserSetting(context.Context, *connect.Request[v1.GetUserSettingRequest]) (*connect.Response[v1.UserSetting], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.GetUserSetting is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUserSetting(context.Context, *connect.Request[v1.UpdateUserSettingRequest]) (*connect.Response[v1.UserSetting], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.UpdateUserSetting is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUserSettings(context.Context, *connect.Request[v1.ListUserSettingsRequest]) (*connect.Response[v1.ListUserSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.ListUserSettings is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListPersonalAccessTokens(context.Context, *connect.Request[v1.ListPersonalAccessTokensRequest]) (*connect.Response[v1.ListPersonalAccessTokensResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.ListPersonalAccessTokens is not implemented"))
}
...
func (UnimplementedUserServiceHandler) CreatePersonalAccessToken(context.Context, *connect.Request[v1.CreatePersonalAccessTokenRequest]) (*connect.Response[v1.CreatePersonalAccessTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.CreatePersonalAccessToken is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeletePersonalAccessToken(context.Context, *connect.Request[v1.DeletePersonalAccessTokenRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.DeletePersonalAccessToken is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUserWebhooks(context.Context, *connect.Request[v1.ListUserWebhooksRequest]) (*connect.Response[v1.ListUserWebhooksResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.ListUserWebhooks is not implemented"))
}
...
func (UnimplementedUserServiceHandler) CreateUserWebhook(context.Context, *connect.Request[v1.CreateUserWebhookRequest]) (*connect.Response[v1.UserWebhook], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.CreateUserWebhook is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUserWebhook(context.Context, *connect.Request[v1.UpdateUserWebhookRequest]) (*connect.Response[v1.UserWebhook], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.UpdateUserWebhook is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUserWebhook(context.Context, *connect.Request[v1.DeleteUserWebhookRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.DeleteUserWebhook is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUserNotifications(context.Context, *connect.Request[v1.ListUserNotificationsRequest]) (*connect.Response[v1.ListUserNotificationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.ListUserNotifications is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUserNotification(context.Context, *connect.Request[v1.UpdateUserNotificationRequest]) (*connect.Response[v1.UserNotification], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.UpdateUserNotification is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUserNotification(context.Context, *connect.Request[v1.DeleteUserNotificationRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.UserService.DeleteUserNotification is not implemented"))
}
