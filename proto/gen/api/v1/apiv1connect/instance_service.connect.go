...
const (
	...
	InstanceServiceName = "gomemo.api.v1.InstanceService"
)
...
const (
	...
	InstanceServiceGetInstanceProfileProcedure = "/gomemo.api.v1.InstanceService/GetInstanceProfile"
	// InstanceServiceGetInstanceSettingProcedure is the fully-qualified name of the InstanceService's
	// GetInstanceSetting RPC.
	InstanceServiceGetInstanceSettingProcedure = "/gomemo.api.v1.InstanceService/GetInstanceSetting"
	...
	InstanceServiceUpdateInstanceSettingProcedure = "/gomemo.api.v1.InstanceService/UpdateInstanceSetting"
)

// InstanceServiceClient is a client for the gomemo.api.v1.InstanceService service.
...
// NewInstanceServiceClient constructs a client for the gomemo.api.v1.InstanceService service. By
...
// GetInstanceProfile calls gomemo.api.v1.InstanceService.GetInstanceProfile.
...
// GetInstanceSetting calls gomemo.api.v1.InstanceService.GetInstanceSetting.
...
// UpdateInstanceSetting calls gomemo.api.v1.InstanceService.UpdateInstanceSetting.
...
// InstanceServiceHandler is an implementation of the gomemo.api.v1.InstanceService service.
...
func NewInstanceServiceHandler(svc InstanceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gomemo.api.v1.InstanceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedInstanceServiceHandler) GetInstanceProfile(context.Context, *connect.Request[v1.GetInstanceProfileRequest]) (*connect.Response[v1.InstanceProfile], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.InstanceService.GetInstanceProfile is not implemented"))
}
...
func (UnimplementedInstanceServiceHandler) GetInstanceSetting(context.Context, *connect.Request[v1.GetInstanceSettingRequest]) (*connect.Response[v1.InstanceSetting], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.InstanceService.GetInstanceSetting is not implemented"))
}
...
func (UnimplementedInstanceServiceHandler) UpdateInstanceSetting(context.Context, *connect.Request[v1.UpdateInstanceSettingRequest]) (*connect.Response[v1.InstanceSetting], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.InstanceService.UpdateInstanceSetting is not implemented"))
}
