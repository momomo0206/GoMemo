...
const (
	...
	AuthServiceName = "gomemo.api.v1.AuthService"
)
...
const (
	...
	// GetCurrentUser RPC.
	AuthServiceGetCurrentUserProcedure = "/gomemo.api.v1.AuthService/GetCurrentUser"
	// AuthServiceSignInProcedure is the fully-qualified name of the AuthService's SignIn RPC.
	AuthServiceSignInProcedure = "/gomemo.api.v1.AuthService/SignIn"
	// AuthServiceSignOutProcedure is the fully-qualified name of the AuthService's SignOut RPC.
	AuthServiceSignOutProcedure = "/gomemo.api.v1.AuthService/SignOut"
	// AuthServiceRefreshTokenProcedure is the fully-qualified name of the AuthService's RefreshToken
	// RPC.
	AuthServiceRefreshTokenProcedure = "/gomemo.api.v1.AuthService/RefreshToken"
)

// AuthServiceClient is a client for the gomemo.api.v1.AuthService service.
type AuthServiceClient interface {
	...
	// Revokes the refresh token and clear the authentication cookie.
...
// NewAuthServiceClient constructs a client for the gomemo.api.v1.AuthService service. By default,
...
// GetCurrentUser calls gomemo.api.v1.AuthService.GetCurrentUser.
...
// SignIn calls gomemo.api.v1.AuthService.SignIn.
...
// SignOut calls gomemo.api.v1.AuthService.SignOut.
...
// RefreshToken calls gomemo.api.v1.AuthService.RefreshToken.
...
// AuthServiceHandler is an implementation of the gomemo.api.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gomemo.api.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) GetCurrentUser(context.Context, *connect.Request[v1.GetCurrentUserRequest]) (*connect.Response[v1.GetCurrentUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.AuthService.GetCurrentUser is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) SignIn(context.Context, *connect.Request[v1.SignInRequest]) (*connect.Response[v1.SignInResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.AuthService.SignIn is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) SignOut(context.Context, *connect.Request[v1.SignOutRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.AuthService.SignOut is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) RefreshToken(context.Context, *connect.Request[v1.RefreshTokenRequest]) (*connect.Response[v1.RefreshTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.AuthService.RefreshToken is not implemented"))
}
