...
const (
	...
	AttachmentServiceName = "gomemo.api.v1.AttachmentService"
)
...
const (
	...
	AttachmentServiceCreateAttachmentProcedure = "/gomemo.api.v1.AttachmentService/CreateAttachment"
	// AttachmentServiceListAttachmentsProcedure is the fully-qualified name of the AttachmentService's
	// ListAttachments RPC.
	AttachmentServiceListAttachmentsProcedure = "/gomemo.api.v1.AttachmentService/ListAttachments"
	// AttachmentServiceGetAttachmentProcedure is the fully-qualified name of the AttachmentService's
	// GetAttachment RPC.
	AttachmentServiceGetAttachmentProcedure = "/gomemo.api.v1.AttachmentService/GetAttachment"
	// AttachmentServiceUpdateAttachmentProcedure is the fully-qualified name of the AttachmentService's
	// UpdateAttachment RPC.
	AttachmentServiceUpdateAttachmentProcedure = "/gomemo.api.v1.AttachmentService/UpdateAttachment"
	// AttachmentServiceDeleteAttachmentProcedure is the fully-qualified name of the AttachmentService's
	// DeleteAttachment RPC.
	AttachmentServiceDeleteAttachmentProcedure = "/gomemo.api.v1.AttachmentService/DeleteAttachment"
)

// AttachmentServiceClient is a client for the gomemo.api.v1.AttachmentService service.
type AttachmentServiceClient interface {
	...
	// UpdateAttachment update a attachment.
...
// NewAttachmentServiceClient constructs a client for the gomemo.api.v1.AttachmentService service.
...
// CreateAttachment calls gomemo.api.v1.AttachmentService.CreateAttachment.
...
// ListAttachments calls gomemo.api.v1.AttachmentService.ListAttachments.
...
// GetAttachment calls gomemo.api.v1.AttachmentService.GetAttachment.
...
// UpdateAttachment calls gomemo.api.v1.AttachmentService.UpdateAttachment.
...
// DeleteAttachment calls gomemo.api.v1.AttachmentService.DeleteAttachment.
...
// AttachmentServiceHandler is an implementation of the gomemo.api.v1.AttachmentService service.
...
func NewAttachmentServiceHandler(svc AttachmentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gomemo.api.v1.AttachmentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAttachmentServiceHandler) CreateAttachment(context.Context, *connect.Request[v1.CreateAttachmentRequest]) (*connect.Response[v1.Attachment], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.AttachmentService.CreateAttachment is not implemented"))
}
...
func (UnimplementedAttachmentServiceHandler) ListAttachments(context.Context, *connect.Request[v1.ListAttachmentsRequest]) (*connect.Response[v1.ListAttachmentsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.AttachmentService.ListAttachments is not implemented"))
}
...
func (UnimplementedAttachmentServiceHandler) GetAttachment(context.Context, *connect.Request[v1.GetAttachmentRequest]) (*connect.Response[v1.Attachment], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.AttachmentService.GetAttachment is not implemented"))
}
...
func (UnimplementedAttachmentServiceHandler) UpdateAttachment(context.Context, *connect.Request[v1.UpdateAttachmentRequest]) (*connect.Response[v1.Attachment], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.AttachmentService.UpdateAttachment is not implemented"))
}
...
func (UnimplementedAttachmentServiceHandler) DeleteAttachment(context.Context, *connect.Request[v1.DeleteAttachmentRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.AttachmentService.DeleteAttachment is not implemented"))
}
