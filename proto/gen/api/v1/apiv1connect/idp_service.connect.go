...
const (
	...
	IdentityProviderServiceName = "gomemo.api.v1.IdentityProviderService"
)
...
const (
	...
	IdentityProviderServiceListIdentityProvidersProcedure = "/gomemo.api.v1.IdentityProviderService/ListIdentityProviders"
	...
	IdentityProviderServiceGetIdentityProviderProcedure = "/gomemo.api.v1.IdentityProviderService/GetIdentityProvider"
	...
	IdentityProviderServiceCreateIdentityProviderProcedure = "/gomemo.api.v1.IdentityProviderService/CreateIdentityProvider"
	...
	IdentityProviderServiceUpdateIdentityProviderProcedure = "/gomemo.api.v1.IdentityProviderService/UpdateIdentityProvider"
	...
	IdentityProviderServiceDeleteIdentityProviderProcedure = "/gomemo.api.v1.IdentityProviderService/DeleteIdentityProvider"
)

// IdentityProviderServiceClient is a client for the gomemo.api.v1.IdentityProviderService service.
type IdentityProviderServiceClient interface {
	...
	// GetIdentityProviders gets an identity provider.
...
// gomemo.api.v1.IdentityProviderService service. By default, it uses the Connect protocol with the
...
// ListIdentityProviders calls gomemo.api.v1.IdentityProviderService.ListIdentityProviders.
...
// GetIdentityProvider calls gomemo.api.v1.IdentityProviderService.GetIdentityProvider.
...
// CreateIdentityProvider calls gomemo.api.v1.IdentityProviderService.CreateIdentityProvider.
...
// UpdateIdentityProvider calls gomemo.api.v1.IdentityProviderService.UpdateIdentityProvider.
...
// DeleteIdentityProvider calls gomemo.api.v1.IdentityProviderService.DeleteIdentityProvider.
...
// IdentityProviderServiceHandler is an implementation of the gomemo.api.v1.IdentityProviderService
// service.
...
func NewIdentityProviderServiceHandler(svc IdentityProviderServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gomemo.api.v1.IdentityProviderService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedIdentityProviderServiceHandler) ListIdentityProviders(context.Context, *connect.Request[v1.ListIdentityProvidersRequest]) (*connect.Response[v1.ListIdentityProvidersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.IdentityProviderService.ListIdentityProviders is not implemented"))
}
...
func (UnimplementedIdentityProviderServiceHandler) GetIdentityProvider(context.Context, *connect.Request[v1.GetIdentityProviderRequest]) (*connect.Response[v1.IdentityProvider], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.IdentityProviderService.GetIdentityProvider is not implemented"))
}
...
func (UnimplementedIdentityProviderServiceHandler) CreateIdentityProvider(context.Context, *connect.Request[v1.CreateIdentityProviderRequest]) (*connect.Response[v1.IdentityProvider], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.IdentityProviderService.CreateIdentityProvider is not implemented"))
}
...
func (UnimplementedIdentityProviderServiceHandler) UpdateIdentityProvider(context.Context, *connect.Request[v1.UpdateIdentityProviderRequest]) (*connect.Response[v1.IdentityProvider], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.IdentityProviderService.UpdateIdentityProvider is not implemented"))
}
...
func (UnimplementedIdentityProviderServiceHandler) DeleteIdentityProvider(context.Context, *connect.Request[v1.DeleteIdentityProviderRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.IdentityProviderService.DeleteIdentityProvider is not implemented"))
}
