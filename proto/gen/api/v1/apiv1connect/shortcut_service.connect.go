...
const (
	...
	ShortcutServiceName = "gomemo.api.v1.ShortcutService"
)
...
const (
	...
	// ListShortcuts RPC.
	ShortcutServiceListShortcutsProcedure = "/gomemo.api.v1.ShortcutService/ListShortcuts"
	// ShortcutServiceGetShortcutProcedure is the fully-qualified name of the ShortcutService's
	// GetShortcut RPC.
	ShortcutServiceGetShortcutProcedure = "/gomemo.api.v1.ShortcutService/GetShortcut"
	// ShortcutServiceCreateShortcutProcedure is the fully-qualified name of the ShortcutService's
	// CreateShortcut RPC.
	ShortcutServiceCreateShortcutProcedure = "/gomemo.api.v1.ShortcutService/CreateShortcut"
	// ShortcutServiceUpdateShortcutProcedure is the fully-qualified name of the ShortcutService's
	// UpdateShortcut RPC.
	ShortcutServiceUpdateShortcutProcedure = "/gomemo.api.v1.ShortcutService/UpdateShortcut"
	// ShortcutServiceDeleteShortcutProcedure is the fully-qualified name of the ShortcutService's
	// DeleteShortcut RPC.
	ShortcutServiceDeleteShortcutProcedure = "/gomemo.api.v1.ShortcutService/DeleteShortcut"
)

// ShortcutServiceClient is a client for the gomemo.api.v1.ShortcutService service.
...
// NewShortcutServiceClient constructs a client for the gomemo.api.v1.ShortcutService service. By
...
// ListShortcuts calls gomemo.api.v1.ShortcutService.ListShortcuts.
...
// GetShortcut calls gomemo.api.v1.ShortcutService.GetShortcut.
...
// CreateShortcut calls gomemo.api.v1.ShortcutService.CreateShortcut.
...
// UpdateShortcut calls gomemo.api.v1.ShortcutService.UpdateShortcut.
...
// DeleteShortcut calls gomemo.api.v1.ShortcutService.DeleteShortcut.
...
// ShortcutServiceHandler is an implementation of the gomemo.api.v1.ShortcutService service.
...
func NewShortcutServiceHandler(svc ShortcutServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gomemo.api.v1.ShortcutService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedShortcutServiceHandler) ListShortcuts(context.Context, *connect.Request[v1.ListShortcutsRequest]) (*connect.Response[v1.ListShortcutsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.ShortcutService.ListShortcuts is not implemented"))
}
...
func (UnimplementedShortcutServiceHandler) GetShortcut(context.Context, *connect.Request[v1.GetShortcutRequest]) (*connect.Response[v1.Shortcut], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.ShortcutService.GetShortcut is not implemented"))
}
...
func (UnimplementedShortcutServiceHandler) CreateShortcut(context.Context, *connect.Request[v1.CreateShortcutRequest]) (*connect.Response[v1.Shortcut], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.ShortcutService.CreateShortcut is not implemented"))
}
...
func (UnimplementedShortcutServiceHandler) UpdateShortcut(context.Context, *connect.Request[v1.UpdateShortcutRequest]) (*connect.Response[v1.Shortcut], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.ShortcutService.UpdateShortcut is not implemented"))
}
...
func (UnimplementedShortcutServiceHandler) DeleteShortcut(context.Context, *connect.Request[v1.DeleteShortcutRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.ShortcutService.DeleteShortcut is not implemented"))
}
