...
const (
	...
	ActivityServiceName = "gomemo.api.v1.ActivityService"
)
...
const (
	...
	// ListActivities RPC.
	ActivityServiceListActivitiesProcedure = "/gomemo.api.v1.ActivityService/ListActivities"
	// ActivityServiceGetActivityProcedure is the fully-qualified name of the ActivityService's
	// GetActivity RPC.
	ActivityServiceGetActivityProcedure = "/gomemo.api.v1.ActivityService/GetActivity"
)

// ActivityServiceClient is a client for the gomemo.api.v1.ActivityService service.
type ActivityServiceClient interface {
	// ListActivities return a list of activity.
...
// NewActivityServiceClient constructs a client for the gomemo.api.v1.ActivityService service. By
...
// ListActivities calls gomemo.api.v1.ActivityService.ListActivities.
...
// GetActivity calls gomemo.api.v1.ActivityService.GetActivity.
...
// ActivityServiceHandler is an implementation of the gomemo.api.v1.ActivityService service.
...
func NewActivityServiceHandler(svc ActivityServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gomemo.api.v1.ActivityService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedActivityServiceHandler) ListActivities(context.Context, *connect.Request[v1.ListActivitiesRequest]) (*connect.Response[v1.ListActivitiesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.ActivityService.ListActivities is not implemented"))
}
...
func (UnimplementedActivityServiceHandler) GetActivity(context.Context, *connect.Request[v1.GetActivityRequest]) (*connect.Response[v1.Activity], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomemo.api.v1.ActivityService.GetActivity is not implemented"))
}
