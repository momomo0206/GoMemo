...
type Memo struct {
	...
	State State `protobuf:"varint,2,opt,name=state,proto3,enum=gomemo.api.v1.State" json:"state,omitempty"`
	...
	Visibility Visibility `protobuf:"varint,9,opt,name=visibility,proto3,enum=gomemo.api.v1.Visibility" json:"visibility,omitempty"`
...
type ListMemosRequest struct {
	...
	// Optionall. The state of the memo to list.
	// Default to `NORMAL`. Set to `ARCHIVED` to list archived memos.
	State State `protobuf:"varint,3,opt,name=state,proto3,enum=gomemo.api.v1.State" json:"state,omitempty"`
	// Optional. The order to sort results by.
	// Default to "dispaly_time desc".
...
type MemoRelation struct {
	...
	Type          MemoRelation_Type  `protobuf:"varint,3,opt,name=type,proto3,enum=gomemo.api.v1.MemoRelation_Type" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	"\n" +
	"\x19api/v1/memo_service.proto\x12\rgomemo.api.v1\x1a\x1fapi/v1/attachment_service.proto\x1a\x13api/v1/common.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xde\x02\n" +
	"\bReaction\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xe0A\x03\xe0A\bR\x04name\x124\n" +
	"\acreator\x18\x02 \x01(\tB\x1a\xe0A\x03\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\acreator\x129\n" +
	"\n" +
	"content_id\x18\x03 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/MemoR\tcontentId\x12(\n" +
	"\rreaction_type\x18\x04 \x01(\tB\x03\xe0A\x02R\freactionType\x12@\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\n" +
	"createTime:Y\xeaAV\n" +
	"\x16gomemo.api.v1/Reaction\x12!memos/{memo}/reactions/{reaction}\x1a\x04name*\treactions2\breaction\"\xe2\b\n" +
	"\x04Memo\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12/\n" +
	"\x05state\x18\x02 \x01(\x0e2\x14.gomemo.api.v1.StateB\x03\xe0A\x02R\x05state\x124\n" +
	"\acreator\x18\x03 \x01(\tB\x1a\xe0A\x03\xfaA\x14\n" +
	"\x12gomemo.api.v1/UserR\acreator\x12@\n" +
	...
	"\n" +
	"visibility\x18\t \x01(\x0e2\x19.gomemo.api.v1.VisibilityB\x03\xe0A\x02R\n" +
	"visibility\x12\x17\n" +
	"\x04tags\x18\n" +
	" \x03(\tB\x03\xe0A\x03R\x04tags\x12\x1b\n" +
	"\x06pinned\x18\v \x01(\bB\x03\xe0A\x01R\x06pinned\x12@\n" +
	"\vattachments\x18\f \x03(\v2\x19.gomemo.api.v1.AttachmentB\x03\xe0A\x01R\vattachments\x12>\n" +
	"\trelations\x18\r \x03(\v2\x1b.gomemo.api.v1.MemoRelationB\x03\xe0A\x01R\trelations\x12:\n" +
	"\treactions\x18\x0e \x03(\v2\x17.gomemo.api.v1.ReactionB\x03\xe0A\x03R\treactions\x12=\n" +
	"\bproperty\x18\x0f \x01(\v2\x1c.gomemo.api.v1.Memo.PropertyB\x03\xe0A\x03R\bproperty\x127\n" +
	"\x06parent\x18\x10 \x01(\tB\x1a\xe0A\x03\xfaA\x14\n" +
	"\x12gomemo.api.v1/MemoH\x00R\x06parent\x88\x01\x01\x12\x1d\n" +
	"\asnippet\x18\x11 \x01(\tB\x03\xe0A\x03R\asnippet\x12=\n" +
	"\blocation\x18\x12 \x01(\v2\x17.gomemo.api.v1.LocationB\x03\xe0A\x01H\x01R\blocation\x88\x01\x01\x1a\x96\x01\n" +
	"\bProperty\x12\x19\n" +
	...
	"\x14has_incomplete_tasks\x18\x04 \x01(\bR\x12hasIncompleteTasks:8\xeaA5\n" +
	"\x12gomemo.api.v1/Memo\x12\fmemos/{memo}\x1a\x04name*\x05memos2\x04memoB\t\n" +
	"\a_parentB\v\n" +
	"\t_location\"u\n" +
	"\bLocation\x12%\n" +
	"\vplaceholder\x18\x01 \x01(\tB\x03\xe0A\x01R\vplaceholder\x12\x1f\n" +
	"\blatitude\x18\x02 \x01(\x01B\x03\xe0A\x01R\blatitude\x12!\n" +
	"\tlongitude\x18\x03 \x01(\x01B\x03\xe0A\x01R\tlongitude\"_\n" +
	"\x11CreateMemoRequest\x12,\n" +
	"\x04memo\x18\x01 \x01(\v2\x13.gomemo.api.v1.MemoB\x03\xe0A\x02R\x04memo\x12\x1c\n" +
	"\amemo_id\x18\x02 \x01(\tB\x03\xe0A\x01R\x06memoId\"\xee\x01\n" +
	"\x10ListMemosRequest\x12 \n" +
	"\tpage_size\x18\x01 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tB\x03\xe0A\x01R\tpageToken\x12/\n" +
	"\x05state\x18\x03 \x01(\x0e2\x14.gomemo.api.v1.StateB\x03\xe0A\x01R\x05state\x12\x1e\n" +
	"\border_by\x18\x04 \x01(\tB\x03\xe0A\x01R\aorderBy\x12\x1b\n" +
	"\x06filter\x18\x05 \x01(\tB\x03\xe0A\x01R\x06filter\x12&\n" +
	"\fshow_deleted\x18\x06 \x01(\bB\x03\xe0A\x01R\vshowDeleted\"f\n" +
	"\x11ListMemosResponse\x12)\n" +
	"\x05memos\x18\x01 \x03(\v2\x13.gomemo.api.v1.MemoR\x05memos\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"@\n" +
	"\x0eGetMemoRequest\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/MemoR\x04name\"\x83\x01\n" +
	"\x11UpdateMemoRequest\x12,\n" +
	"\x04memo\x18\x01 \x01(\v2\x13.gomemo.api.v1.MemoB\x03\xe0A\x02R\x04memo\x12@\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02R\n" +
	"updateMask\"C\n" +
	"\x11DeleteMemoRequest\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/MemoR\x04name\"\x8d\x01\n" +
	"\x19SetMemoAttachmentsRequest\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/MemoR\x04name\x12@\n" +
	"\vattachments\x18\x02 \x03(\v2\x19.gomemo.api.v1.AttachmentB\x03\xe0A\x02R\vattachments\"\x92\x01\n" +
	...
	"\vattachments\x18\x01 \x03(\v2\x19.gomemo.api.v1.AttachmentR\vattachments\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xdf\x02\n" +
	"\fMemoRelation\x129\n" +
	"\x04memo\x18\x01 \x01(\v2 .gomemo.api.v1.MemoRelation.MemoB\x03\xe0A\x02R\x04memo\x12H\n" +
	"\frelated_memo\x18\x02 \x01(\v2 .gomemo.api.v1.MemoRelation.MemoB\x03\xe0A\x02R\vrelatedMemo\x129\n" +
	"\x04type\x18\x03 \x01(\x0e2 .gomemo.api.v1.MemoRelation.TypeB\x03\xe0A\x02R\x04type\x1aU\n" +
	"\x04Memo\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/MemoR\x04name\x12\x1d\n" +
	"\asnippet\x18\x02 \x01(\tB\x03\xe0A\x03R\asnippet\"8\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tREFERENCE\x10\x01\x12\v\n" +
	"\aCOMMENT\x10\x02\"\x89\x01\n" +
	"\x17SetMemoRelationsRequest\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/MemoR\x04name\x12>\n" +
	"\trelations\x18\x02 \x03(\v2\x1b.gomemo.api.v1.MemoRelationB\x03\xe0A\x02R\trelations\"\x90\x01\n" +
	...
	"\x19ListMemoRelationsResponse\x129\n" +
	"\trelations\x18\x01 \x03(\v2\x1b.gomemo.api.v1.MemoRelationR\trelations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xa2\x01\n" +
	"\x18CreateMemoCommentRequest\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/MemoR\x04name\x122\n" +
	"\acomment\x18\x02 \x01(\v2\x13.gomemo.api.v1.MemoB\x03\xe0A\x02R\acomment\x12\"\n" +
	"\n" +
	"comment_id\x18\x03 \x01(\tB\x03\xe0A\x01R\tcommentId\"\xaf\x01\n" +
	...
	"\border_by\x18\x04 \x01(\tB\x03\xe0A\x01R\aorderBy\"\x8c\x01\n" +
	...
	"\x19ListMemoReactionsResponse\x125\n" +
	"\treactions\x18\x01 \x03(\v2\x17.gomemo.api.v1.ReactionR\treactions\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"\x85\x01\n" +
	"\x19UpsertMemoReactionRequest\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xe0A\x02\xfaA\x14\n" +
	"\x12gomemo.api.v1/MemoR\x04name\x128\n" +
	"\breaction\x18\x02 \x01(\v2\x17.gomemo.api.v1.ReactionB\x03\xe0A\x02R\breaction\"O\n" +
	"\x19DeleteMemoReactionRequest\x122\n" +
	"\x04name\x18\x01 \x01(\tB\x1e\xe0A\x02\xfaA\x18\n" +
	"\x16gomemo.api.v1/ReactionR\x04name*P\n" +
	"\n" +
	"Visibility\x12\x1a\n" +
	...
	"\n" +
	"\x06PUBLIC\x10\x032\xec\x0e\n" +
	"\vMemoService\x12g\n" +
	"\n" +
	"CreateMemo\x12 .gomemo.api.v1.CreateMemoRequest\x1a\x13.gomemo.api.v1.Memo\"\"\xdaA\x04memo\x82\xd3\xe4\x93\x02\x15:\x04memo\"\r/api/v1/memos\x12h\n" +
	"\tListMemos\x12\x1f.gomemo.api.v1.ListMemosRequest\x1a .gomemo.api.v1.ListMemosResponse\"\x18\xdaA\x00\x82\xd3\xe4\x93\x02\x0f\x12\r/api/v1/memos\x12d\n" +
	"\aGetMemo\x12\x1d.gomemo.api.v1.GetMemoRequest\x1a\x13.gomemo.api.v1.Memo\"%\xdaA\x04name\x82\xd3\xe4\x93\x02\x18\x12\x16/api/v1/{name=memos/*}\x12\x81\x01\n" +
	"\n" +
	"UpdateMemo\x12 .gomemo.api.v1.UpdateMemoRequest\x1a\x13.gomemo.api.v1.Memo\"<\xdaA\x10memo,update_mask\x82\xd3\xe4\x93\x02#:\x04memo2\x1b/api/v1/{memo.name=memos/*}\x12m\n" +
	"\n" +
	"DeleteMemo\x12 .gomemo.api.v1.DeleteMemoRequest\x1a\x16.google.protobuf.Empty\"%\xdaA\x04name\x82\xd3\xe4\x93\x02\x18*\x16/api/v1/{name=memos/*}\x12\x8c\x01\n" +
	"\x12SetMemoAttachments\x12(.gomemo.api.v1.SetMemoAttachmentsRequest\x1a\x16.google.protobuf.Empty\"4\xdaA\x04name\x82\xd3\xe4\x93\x02':\x01*2\"/api/v1/{name=memos/*}/attachments\x12\x9f\x01\n" +
	"\x13ListMemoAttachments\x12).gomemo.api.v1.ListMemoAttachmentsRequest\x1a*.gomemo.api.v1.ListMemoAttachmentsResponse\"1\xdaA\x04name\x82\xd3\xe4\x93\x02$\x12\"/api/v1/{name=memos/*}/attachments\x12\x86\x01\n" +
	"\x10SetMemoRelations\x12&.gomemo.api.v1.SetMemoRelationsRequest\x1a\x16.google.protobuf.Empty\"2\xdaA\x04name\x82\xd3\xe4\x93\x02%:\x01*2 /api/v1/{name=memos/*}/relations\x12\x97\x01\n" +
	"\x11ListMemoRelations\x12'.gomemo.api.v1.ListMemoRelationsRequest\x1a(.gomemo.api.v1.ListMemoRelationsResponse\"/\xdaA\x04name\x82\xd3\xe4\x93\x02\"\x12 /api/v1/{name=memos/*}/relations\x12\x92\x01\n" +
	"\x11CreateMemoComment\x12'.gomemo.api.v1.CreateMemoCommentRequest\x1a\x13.gomemo.api.v1.Memo\"?\xdaA\fname,comment\x82\xd3\xe4\x93\x02*:\acomment\"\x1f/api/v1/{name=memos/*}/comments\x12\x93\x01\n" +
	"\x10ListMemoComments\x12&.gomemo.api.v1.ListMemoCommentsRequest\x1a'.gomemo.api.v1.ListMemoCommentsResponse\".\xdaA\x04name\x82\xd3\xe4\x93\x02!\x12\x1f/api/v1/{name=memos/*}/comments\x12\x97\x01\n" +
	"\x11ListMemoReactions\x12'.gomemo.api.v1.ListMemoReactionsRequest\x1a(.gomemo.api.v1.ListMemoReactionsResponse\"/\xdaA\x04name\x82\xd3\xe4\x93\x02\"\x12 /api/v1/{name=memos/*}/reactions\x12\x8b\x01\n" +
	"\x12UpsertMemoReaction\x12(.gomemo.api.v1.UpsertMemoReactionRequest\x1a\x17.gomemo.api.v1.Reaction\"2\xdaA\x04name\x82\xd3\xe4\x93\x02%:\x01*2 /api/v1/{name=memos/*}/reactions\x12\x89\x01\n" +
	"\x12DeleteMemoReaction\x12(.gomemo.api.v1.DeleteMemoReactionRequest\x1a\x16.google.protobuf.Empty\"1\xdaA\x04name\x82\xd3\xe4\x93\x02$*\"/api/v1/{name=memos/*/reactions/*}B\xb0\x01\n" +
	"\x11com.gomemo.api.v1B\x10MemoServiceProtoP\x01Z3github.com/momomo0206/gomemo/proto/gen/api/v1;apiv1\xa2\x02\x03GAX\xaa\x02\rGomemo.Api.V1\xca\x02\rGomemo\\Api\\V1\xe2\x02\x19Gomemo\\Api\\V1\\GPBMetadata\xea\x02\x0fGomemo::Api::V1b\x06proto3"
...
var file_api_v1_memo_service_proto_goTypes = []any{
	(Visibility)(0),                     // 0: gomemo.api.v1.Visibility
	(MemoRelation_Type)(0),              // 1: gomemo.api.v1.MemoRelation.Type
	(*Reaction)(nil),                    // 2: gomemo.api.v1.Reaction
	(*Memo)(nil),                        // 3: gomemo.api.v1.Memo
	(*Location)(nil),                    // 4: gomemo.api.v1.Location
	(*CreateMemoRequest)(nil),           // 5: gomemo.api.v1.CreateMemoRequest
	(*ListMemosRequest)(nil),            // 6: gomemo.api.v1.ListMemosRequest
	(*ListMemosResponse)(nil),           // 7: gomemo.api.v1.ListMemosResponse
	(*GetMemoRequest)(nil),              // 8: gomemo.api.v1.GetMemoRequest
	(*UpdateMemoRequest)(nil),           // 9: gomemo.api.v1.UpdateMemoRequest
	(*DeleteMemoRequest)(nil),           // 10: gomemo.api.v1.DeleteMemoRequest
	(*SetMemoAttachmentsRequest)(nil),   // 11: gomemo.api.v1.SetMemoAttachmentsRequest
	(*ListMemoAttachmentsRequest)(nil),  // 12: gomemo.api.v1.ListMemoAttachmentsRequest
	(*ListMemoAttachmentsResponse)(nil), // 13: gomemo.api.v1.ListMemoAttachmentsResponse
	(*MemoRelation)(nil),                // 14: gomemo.api.v1.MemoRelation
	(*SetMemoRelationsRequest)(nil),     // 15: gomemo.api.v1.SetMemoRelationsRequest
	(*ListMemoRelationsRequest)(nil),    // 16: gomemo.api.v1.ListMemoRelationsRequest
	(*ListMemoRelationsResponse)(nil),   // 17: gomemo.api.v1.ListMemoRelationsResponse
	(*CreateMemoCommentRequest)(nil),    // 18: gomemo.api.v1.CreateMemoCommentRequest
	(*ListMemoCommentsRequest)(nil),     // 19: gomemo.api.v1.ListMemoCommentsRequest
	(*ListMemoCommentsResponse)(nil),    // 20: gomemo.api.v1.ListMemoCommentsResponse
	(*ListMemoReactionsRequest)(nil),    // 21: gomemo.api.v1.ListMemoReactionsRequest
	(*ListMemoReactionsResponse)(nil),   // 22: gomemo.api.v1.ListMemoReactionsResponse
	(*UpsertMemoReactionRequest)(nil),   // 23: gomemo.api.v1.UpsertMemoReactionRequest
	(*DeleteMemoReactionRequest)(nil),   // 24: gomemo.api.v1.DeleteMemoReactionRequest
	(*Memo_Property)(nil),               // 25: gomemo.api.v1.Memo.Property
	(*MemoRelation_Memo)(nil),           // 26: gomemo.api.v1.MemoRelation.Memo
	(*timestamppb.Timestamp)(nil),       // 27: google.protobuf.Timestamp
	(State)(0),                          // 28: gomemo.api.v1.State
	(*Attachment)(nil),                  // 29: gomemo.api.v1.Attachment
	(*fieldmaskpb.FieldMask)(nil),       // 30: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),               // 31: google.protobuf.Empty
}
var file_api_v1_memo_service_proto_depIdxs = []int32{
	27, // 0: gomemo.api.v1.Reaction.create_time:type_name -> google.protobuf.Timestamp
	28, // 1: gomemo.api.v1.Memo.state:type_name -> gomemo.api.v1.State
	27, // 2: gomemo.api.v1.Memo.create_time:type_name -> google.protobuf.Timestamp
	27, // 3: gomemo.api.v1.Memo.update_time:type_name -> google.protobuf.Timestamp
	27, // 4: gomemo.api.v1.Memo.display_time:type_name -> google.protobuf.Timestamp
	0,  // 5: gomemo.api.v1.Memo.visibility:type_name -> gomemo.api.v1.Visibility
	29, // 6: gomemo.api.v1.Memo.attachments:type_name -> gomemo.api.v1.Attachment
	14, // 7: gomemo.api.v1.Memo.relations:type_name -> gomemo.api.v1.MemoRelation
	2,  // 8: gomemo.api.v1.Memo.reactions:type_name -> gomemo.api.v1.Reaction
	25, // 9: gomemo.api.v1.Memo.property:type_name -> gomemo.api.v1.Memo.Property
	4,  // 10: gomemo.api.v1.Memo.location:type_name -> gomemo.api.v1.Location
	3,  // 11: gomemo.api.v1.CreateMemoRequest.memo:type_name -> gomemo.api.v1.Memo
	28, // 12: gomemo.api.v1.ListMemosRequest.state:type_name -> gomemo.api.v1.State
	3,  // 13: gomemo.api.v1.ListMemosResponse.memos:type_name -> gomemo.api.v1.Memo
	3,  // 14: gomemo.api.v1.UpdateMemoRequest.memo:type_name -> gomemo.api.v1.Memo
	30, // 15: gomemo.api.v1.UpdateMemoRequest.update_mask:type_name -> google.protobuf.FieldMask
	29, // 16: gomemo.api.v1.SetMemoAttachmentsRequest.attachments:type_name -> gomemo.api.v1.Attachment
	29, // 17: gomemo.api.v1.ListMemoAttachmentsResponse.attachments:type_name -> gomemo.api.v1.Attachment
	26, // 18: gomemo.api.v1.MemoRelation.memo:type_name -> gomemo.api.v1.MemoRelation.Memo
	26, // 19: gomemo.api.v1.MemoRelation.related_memo:type_name -> gomemo.api.v1.MemoRelation.Memo
	1,  // 20: gomemo.api.v1.MemoRelation.type:type_name -> gomemo.api.v1.MemoRelation.Type
	14, // 21: gomemo.api.v1.SetMemoRelationsRequest.relations:type_name -> gomemo.api.v1.MemoRelation
	14, // 22: gomemo.api.v1.ListMemoRelationsResponse.relations:type_name -> gomemo.api.v1.MemoRelation
	3,  // 23: gomemo.api.v1.CreateMemoCommentRequest.comment:type_name -> gomemo.api.v1.Memo
	3,  // 24: gomemo.api.v1.ListMemoCommentsResponse.memos:type_name -> gomemo.api.v1.Memo
	2,  // 25: gomemo.api.v1.ListMemoReactionsResponse.reactions:type_name -> gomemo.api.v1.Reaction
	2,  // 26: gomemo.api.v1.UpsertMemoReactionRequest.reaction:type_name -> gomemo.api.v1.Reaction
	5,  // 27: gomemo.api.v1.MemoService.CreateMemo:input_type -> gomemo.api.v1.CreateMemoRequest
	6,  // 28: gomemo.api.v1.MemoService.ListMemos:input_type -> gomemo.api.v1.ListMemosRequest
	8,  // 29: gomemo.api.v1.MemoService.GetMemo:input_type -> gomemo.api.v1.GetMemoRequest
	9,  // 30: gomemo.api.v1.MemoService.UpdateMemo:input_type -> gomemo.api.v1.UpdateMemoRequest
	10, // 31: gomemo.api.v1.MemoService.DeleteMemo:input_type -> gomemo.api.v1.DeleteMemoRequest
	11, // 32: gomemo.api.v1.MemoService.SetMemoAttachments:input_type -> gomemo.api.v1.SetMemoAttachmentsRequest
	12, // 33: gomemo.api.v1.MemoService.ListMemoAttachments:input_type -> gomemo.api.v1.ListMemoAttachmentsRequest
	15, // 34: gomemo.api.v1.MemoService.SetMemoRelations:input_type -> gomemo.api.v1.SetMemoRelationsRequest
	16, // 35: gomemo.api.v1.MemoService.ListMemoRelations:input_type -> gomemo.api.v1.ListMemoRelationsRequest
	18, // 36: gomemo.api.v1.MemoService.CreateMemoComment:input_type -> gomemo.api.v1.CreateMemoCommentRequest
	19, // 37: gomemo.api.v1.MemoService.ListMemoComments:input_type -> gomemo.api.v1.ListMemoCommentsRequest
	21, // 38: gomemo.api.v1.MemoService.ListMemoReactions:input_type -> gomemo.api.v1.ListMemoReactionsRequest
	23, // 39: gomemo.api.v1.MemoService.UpsertMemoReaction:input_type -> gomemo.api.v1.UpsertMemoReactionRequest
	24, // 40: gomemo.api.v1.MemoService.DeleteMemoReaction:input_type -> gomemo.api.v1.DeleteMemoReactionRequest
	3,  // 41: gomemo.api.v1.MemoService.CreateMemo:output_type -> gomemo.api.v1.Memo
	7,  // 42: gomemo.api.v1.MemoService.ListMemos:output_type -> gomemo.api.v1.ListMemosResponse
	3,  // 43: gomemo.api.v1.MemoService.GetMemo:output_type -> gomemo.api.v1.Memo
	3,  // 44: gomemo.api.v1.MemoService.UpdateMemo:output_type -> gomemo.api.v1.Memo
	31, // 45: gomemo.api.v1.MemoService.DeleteMemo:output_type -> google.protobuf.Empty
	31, // 46: gomemo.api.v1.MemoService.SetMemoAttachments:output_type -> google.protobuf.Empty
	13, // 47: gomemo.api.v1.MemoService.ListMemoAttachments:output_type -> gomemo.api.v1.ListMemoAttachmentsResponse
	31, // 48: gomemo.api.v1.MemoService.SetMemoRelations:output_type -> google.protobuf.Empty
	17, // 49: gomemo.api.v1.MemoService.ListMemoRelations:output_type -> gomemo.api.v1.ListMemoRelationsResponse
	3,  // 50: gomemo.api.v1.MemoService.CreateMemoComment:output_type -> gomemo.api.v1.Memo
	20, // 51: gomemo.api.v1.MemoService.ListMemoComments:output_type -> gomemo.api.v1.ListMemoCommentsResponse
	22, // 52: gomemo.api.v1.MemoService.ListMemoReactions:output_type -> gomemo.api.v1.ListMemoReactionsResponse
	2,  // 53: gomemo.api.v1.MemoService.UpsertMemoReaction:output_type -> gomemo.api.v1.Reaction
	31, // 54: gomemo.api.v1.MemoService.DeleteMemoReaction:output_type -> google.protobuf.Empty
