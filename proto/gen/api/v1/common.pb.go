...
const file_api_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x13api/v1/common.proto\x12\rgomemo.api.v1\"9\n" +
	"\tPageToken\x12\x14\n" +
	...
	"\x04DESC\x10\x02B\xab\x01\n" +
	"\x11com.gomemo.api.v1B\vCommonProtoP\x01Z3github.com/momomo0206/gomemo/proto/gen/api/v1;apiv1\xa2\x02\x03GAX\xaa\x02\rGomemo.Api.V1\xca\x02\rGomemo\\Api\\V1\xe2\x02\x19Gomemo\\Api\\V1\\GPBMetadata\xea\x02\x0fGomemo::Api::V1b\x06proto3"
...
var file_api_v1_common_proto_goTypes = []any{
	(State)(0),        // 0: gomemo.api.v1.State
	(Direction)(0),    // 1: gomemo.api.v1.Direction
	(*PageToken)(nil), // 2: gomemo.api.v1.PageToken
}
