...
type Attachment struct {
	...
	// Optional. The externallink of the attachment.
...
type ListAttachmentsRequest struct {
	...
	// Example: "mome_type==\"image/png\"" or "filename.contains(\"test\")".
	// Supported operators: =, !=, <, <=, >, >=, : (contains), in
	// Supported fields: filename, mime_type, create_type, memo.
...
const file_api_v1_attachment_service_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/v1/attachment_service.proto\x12\rgomemo.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfc\x02\n" +
	"\n" +
	"Attachment\x12\x17\n" +
	...
	"\x04memo\x18\b \x01(\tB\x03\xe0A\x01H\x00R\x04memo\x88\x01\x01:P\xeaAM\n" +
	"\x18gomemo.api.v1/Attachment\x12\x18attachments/{attachment}*\vattachments2\n" +
	"attachmentB\a\n" +
	"\x05_memo\"\x83\x01\n" +
	"\x17CreateAttachmentRequest\x12>\n" +
	"\n" +
	"attachment\x18\x01 \x01(\v2\x19.gomemo.api.v1.AttachmentB\x03\xe0A\x02R\n" +
	"attachment\x12(\n" +
	...
	"\x18gomemo.api.v1/AttachmentR\x04name\"\x9b\x01\n" +
	...
	"updateMask\"O\n" +
	"\x17DeleteAttachmentRequest\x124\n" +
	"\x04name\x18\x01 \x01(\tB \xe0A\x02\xfaA\x1a\n" +
	"\x18gomemo.api.v1/AttachmentR\x04name2\xcd\x05\n" +
	"\x11AttachmentService\x12\x8b\x01\n" +
	"\x10CreateAttachment\x12&.gomemo.api.v1.CreateAttachmentRequest\x1a\x19.gomemo.api.v1.Attachment\"4\xdaA\n" +
	"attachment\x82\xd3\xe4\x93\x02!:\n" +
	"attachment\"\x13/api/v1/attachments\x12}\n" +
	"\x0fListAttachments\x12%.gomemo.api.v1.ListAttachmentsRequest\x1a&.gomemo.api.v1.ListAttachmentsResponse\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/api/v1/attachments\x12|\n" +
	"\rGetAttachment\x12#.gomemo.api.v1.GetAttachmentRequest\x1a\x19.gomemo.api.v1.Attachment\"+\xdaA\x04name\x82\xd3\xe4\x93\x02\x1e\x12\x1c/api/v1/{name=attachments/*}\x12\xab\x01\n" +
	"\x10UpdateAttachment\x12&.gomemo.api.v1.UpdateAttachmentRequest\x1a\x19.gomemo.api.v1.Attachment\"T\xdaA\x16attachment,update_mask\x82\xd3\xe4\x93\x025:\n" +
	"attachment2'/api/v1/{attachment.name=attachments/*}\x12\x7f\n" +
	"\x10DeleteAttachment\x12&.gomemo.api.v1.DeleteAttachmentRequest\x1a\x16.google.protobuf.Empty\"+\xdaA\x04name\x82\xd3\xe4\x93\x02\x1e*\x1c/api/v1/{name=attachments/*}B\xb6\x01\n" +
	"\x11com.gomemo.api.v1B\x16AttachmentServiceProtoP\x01Z3github.com/momomo0206/gomemo/proto/gen/api/v1;apiv1\xa2\x02\x03GAX\xaa\x02\rGomemo.Api.V1\xca\x02\rGomemo\\Api\\V1\xe2\x02\x19Gomemo\\Api\\V1\\GPBMetadata\xea\x02\x0fGomemo::Api::V1b\x06proto3"
...
var file_api_v1_attachment_service_proto_goTypes = []any{
	(*Attachment)(nil),              // 0: gomemo.api.v1.Attachment
	(*CreateAttachmentRequest)(nil), // 1: gomemo.api.v1.CreateAttachmentRequest
	(*ListAttachmentsRequest)(nil),  // 2: gomemo.api.v1.ListAttachmentsRequest
	(*ListAttachmentsResponse)(nil), // 3: gomemo.api.v1.ListAttachmentsResponse
	(*GetAttachmentRequest)(nil),    // 4: gomemo.api.v1.GetAttachmentRequest
	(*UpdateAttachmentRequest)(nil), // 5: gomemo.api.v1.UpdateAttachmentRequest
	(*DeleteAttachmentRequest)(nil), // 6: gomemo.api.v1.DeleteAttachmentRequest
	(*timestamppb.Timestamp)(nil),   // 7: google.protobuf.Timestamp
	(*fieldmaskpb.FieldMask)(nil),   // 8: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),           // 9: google.protobuf.Empty
}
var file_api_v1_attachment_service_proto_depIdxs = []int32{
	7,  // 0: gomemo.api.v1.Attachment.create_time:type_name -> google.protobuf.Timestamp
	0,  // 1: gomemo.api.v1.CreateAttachmentRequest.attachment:type_name -> gomemo.api.v1.Attachment
	0,  // 2: gomemo.api.v1.ListAttachmentsResponse.attachments:type_name -> gomemo.api.v1.Attachment
	0,  // 3: gomemo.api.v1.UpdateAttachmentRequest.attachment:type_name -> gomemo.api.v1.Attachment
	8,  // 4: gomemo.api.v1.UpdateAttachmentRequest.update_mask:type_name -> google.protobuf.FieldMask
	1,  // 5: gomemo.api.v1.AttachmentService.CreateAttachment:input_type -> gomemo.api.v1.CreateAttachmentRequest
	2,  // 6: gomemo.api.v1.AttachmentService.ListAttachments:input_type -> gomemo.api.v1.ListAttachmentsRequest
	4,  // 7: gomemo.api.v1.AttachmentService.GetAttachment:input_type -> gomemo.api.v1.GetAttachmentRequest
	5,  // 8: gomemo.api.v1.AttachmentService.UpdateAttachment:input_type -> gomemo.api.v1.UpdateAttachmentRequest
	6,  // 9: gomemo.api.v1.AttachmentService.DeleteAttachment:input_type -> gomemo.api.v1.DeleteAttachmentRequest
	0,  // 10: gomemo.api.v1.AttachmentService.CreateAttachment:output_type -> gomemo.api.v1.Attachment
	3,  // 11: gomemo.api.v1.AttachmentService.ListAttachments:output_type -> gomemo.api.v1.ListAttachmentsResponse
	0,  // 12: gomemo.api.v1.AttachmentService.GetAttachment:output_type -> gomemo.api.v1.Attachment
	0,  // 13: gomemo.api.v1.AttachmentService.UpdateAttachment:output_type -> gomemo.api.v1.Attachment
	9,  // 14: gomemo.api.v1.AttachmentService.DeleteAttachment:output_type -> google.protobuf.Empty
