...
const file_store_activity_proto_rawDesc = "" +
	"\n" +
	"\x14store/activity.proto\x12\fgomemo.store\"]\n" +
	...
	"\fmemo_comment\x18\x01 \x01(\v2(.gomemo.store.ActivityMemoCommentPayloadR\vmemoCommentB\xa0\x01\n" +
	"\x10com.gomemo.storeB\rActivityProtoP\x01Z,github.com/momomo0206/gomemo/proto/gen/store\xa2\x02\x03GSX\xaa\x02\fGomemo.Store\xca\x02\fGomemo\\Store\xe2\x02\x18Gomemo\\Store\\GPBMetadata\xea\x02\rGomemo::Storeb\x06proto3"
...
var file_store_activity_proto_goTypes = []any{
	(*ActivityMemoCommentPayload)(nil), // 0: gomemo.store.ActivityMemoCommentPayload
	(*ActivityPayload)(nil),            // 1: gomemo.store.ActivityPayload
}
var file_store_activity_proto_depIdxs = []int32{
	0, // 0: gomemo.store.ActivityPayload.memo_comment:type_name -> gomemo.store.ActivityMemoCommentPayload
