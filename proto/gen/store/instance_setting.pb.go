...
type InstanceSetting struct {
	...
	Key   InstanceSettingKey     `protobuf:"varint,1,opt,name=key,proto3,enum=gomemo.store.InstanceSettingKey" json:"key,omitempty"`
...
type InstanceGeneralSetting struct {
	...
	// additional style is the additional style.
	...
	// week_start_day_offset is the week start day offset from Snday.
...
type InstanceStorageSetting struct {
	...
	StorageType InstanceStorageSetting_StorageType `protobuf:"varint,1,opt,name=storage_type,json=storageType,proto3,enum=gomemo.store.InstanceStorageSetting_StorageType" json:"storage_type,omitempty"`
	// The template of file path.
	// e.g. assets/{timestamp}_{filemname}
...
type InstanceMemoRelatedSetting struct {
	...
	// reaction is the list of reactions.
...
const file_store_instance_setting_proto_rawDesc = "" +
	"\n" +
	"\x1cstore/instance_setting.proto\x12\fgomemo.store\"\x99\x03\n" +
	"\x0fInstanceSetting\x122\n" +
	"\x03key\x18\x01 \x01(\x0e2 .gomemo.store.InstanceSettingKeyR\x03key\x12I\n" +
	"\rbasic_setting\x18\x02 \x01(\v2\".gomemo.store.InstanceBasicSettingH\x00R\fbasicSetting\x12O\n" +
	"\x0fgeneral_setting\x18\x03 \x01(\v2$.gomemo.store.InstanceGeneralSettingH\x00R\x0egeneralSetting\x12O\n" +
	"\x0fstorage_setting\x18\x04 \x01(\v2$.gomemo.store.InstanceStorageSettingH\x00R\x0estorageSetting\x12\\\n" +
	"\x14memo_related_setting\x18\x05 \x01(\v2(.gomemo.store.InstanceMemoRelatedSettingH\x00R\x12memoRelatedSettingB\a\n" +
	"\x05value\"\\\n" +
	"\x14InstanceBasicSetting\x12\x1d\n" +
	"\n" +
	"secret_key\x18\x01 \x01(\tR\tsecretKey\x12%\n" +
	"\x0eschema_version\x18\x02 \x01(\tR\rschemaVersion\"\xd7\x03\n" +
	...
	"\x0ecustom_profile\x18\x06 \x01(\v2#.gomemo.store.InstanceCustomProfileR\rcustomProfile\x121\n" +
	...
	"\blogo_url\x18\x03 \x01(\tR\alogoUrl\"\xd5\x02\n" +
	"\x16InstanceStorageSetting\x12S\n" +
	"\fstorage_type\x18\x01 \x01(\x0e20.gomemo.store.InstanceStorageSetting.StorageTypeR\vstorageType\x12+\n" +
	"\x11filepath_template\x18\x02 \x01(\tR\x10filepathTemplate\x12/\n" +
	"\x14upload_size_limit_mb\x18\x03 \x01(\x03R\x11uploadSizeLimitMb\x12:\n" +
	"\ts3_config\x18\x04 \x01(\v2\x1d.gomemo.store.StorageS3ConfigR\bs3Config\"L\n" +
	...
	"\fMEMO_RELATED\x10\x04B\xa7\x01\n" +
	"\x10com.gomemo.storeB\x14InstanceSettingProtoP\x01Z,github.com/momomo0206/gomemo/proto/gen/store\xa2\x02\x03GSX\xaa\x02\fGomemo.Store\xca\x02\fGomemo\\Store\xe2\x02\x18Gomemo\\Store\\GPBMetadata\xea\x02\rGomemo::Storeb\x06proto3"
...
var file_store_instance_setting_proto_goTypes = []any{
	(InstanceSettingKey)(0),                 // 0: gomemo.store.InstanceSettingKey
	(InstanceStorageSetting_StorageType)(0), // 1: gomemo.store.InstanceStorageSetting.StorageType
	(*InstanceSetting)(nil),                 // 2: gomemo.store.InstanceSetting
	(*InstanceBasicSetting)(nil),            // 3: gomemo.store.InstanceBasicSetting
	(*InstanceGeneralSetting)(nil),          // 4: gomemo.store.InstanceGeneralSetting
	(*InstanceCustomProfile)(nil),           // 5: gomemo.store.InstanceCustomProfile
	(*InstanceStorageSetting)(nil),          // 6: gomemo.store.InstanceStorageSetting
	(*StorageS3Config)(nil),                 // 7: gomemo.store.StorageS3Config
	(*InstanceMemoRelatedSetting)(nil),      // 8: gomemo.store.InstanceMemoRelatedSetting
}
var file_store_instance_setting_proto_depIdxs = []int32{
	0, // 0: gomemo.store.InstanceSetting.key:type_name -> gomemo.store.InstanceSettingKey
	3, // 1: gomemo.store.InstanceSetting.basic_setting:type_name -> gomemo.store.InstanceBasicSetting
	4, // 2: gomemo.store.InstanceSetting.general_setting:type_name -> gomemo.store.InstanceGeneralSetting
	6, // 3: gomemo.store.InstanceSetting.storage_setting:type_name -> gomemo.store.InstanceStorageSetting
	8, // 4: gomemo.store.InstanceSetting.memo_related_setting:type_name -> gomemo.store.InstanceMemoRelatedSetting
	5, // 5: gomemo.store.InstanceGeneralSetting.custom_profile:type_name -> gomemo.store.InstanceCustomProfile
	1, // 6: gomemo.store.InstanceStorageSetting.storage_type:type_name -> gomemo.store.InstanceStorageSetting.StorageType
	7, // 7: gomemo.store.InstanceStorageSetting.s3_config:type_name -> gomemo.store.StorageS3Config
