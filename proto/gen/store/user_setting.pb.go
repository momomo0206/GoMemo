...
const (
	...
	UserSetting_SHORTCUTS UserSetting_Key = 2
...
type UserSetting struct {
	...
	Key    UserSetting_Key        `protobuf:"varint,2,opt,name=key,proto3,enum=gomemo.store.UserSetting_Key" json:"key,omitempty"`
...
func (x *GeneralUserSetting) GetLocal() string {
	if x != nil {
		return x.Local
	}
	return ""
...
type WebhooksUserSetting_Webhook struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// Description title for the webhook.
	Title string `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`
...
const file_store_user_setting_proto_rawDesc = "" +
	"\n" +
	"\x18store/user_setting.proto\x12\fgomemo.store\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd1\x04\n" +
	"\vUserSetting\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x05R\x06userId\x12/\n" +
	"\x03key\x18\x02 \x01(\x0e2\x1d.gomemo.store.UserSetting.KeyR\x03key\x12<\n" +
	"\ageneral\x18\x03 \x01(\v2 .gomemo.store.GeneralUserSettingH\x00R\ageneral\x12B\n" +
	"\tshortcuts\x18\x06 \x01(\v2\".gomemo.store.ShortcutsUserSettingH\x00R\tshortcuts\x12?\n" +
	"\bwebhooks\x18\a \x01(\v2!.gomemo.store.WebhooksUserSettingH\x00R\bwebhooks\x12O\n" +
	"\x0erefresh_tokens\x18\b \x01(\v2&.gomemo.store.RefreshTokensUserSettingH\x00R\rrefreshTokens\x12e\n" +
	"\x16personal_access_tokens\x18\t \x01(\v2-.gomemo.store.PersonalAccessTokensUserSettingH\x00R\x14personalAccessTokens\"t\n" +
	"\x03Key\x12\x13\n" +
	"\x0fKEY_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aGENERAL\x10\x01\x12\r\n" +
	"\tSHORTCUTS\x10\x02\x12\f\n" +
	"\bWEBHOOKS\x10\x05\x12\x12\n" +
	"\x0eREFRESH_TOKENS\x10\x06\x12\x1a\n" +
	"\x16PERSONAL_ACCESS_TOKENS\x10\aB\a\n" +
	"\x05value\"i\n" +
	"\x12GeneralUserSetting\x12\x14\n" +
	"\x05local\x18\x01 \x01(\tR\x05local\x12'\n" +
	"\x0fmemo_visibility\x18\x02 \x01(\tR\x0ememoVisibility\x12\x14\n" +
	"\x05theme\x18\x03 \x01(\tR\x05theme\"\xa6\x04\n" +
	"\x18RefreshTokensUserSetting\x12Z\n" +
	"\x0erefresh_tokens\x18\x01 \x03(\v23.gomemo.store.RefreshTokensUserSetting.RefreshTokenR\rrefreshTokens\x1a\x95\x02\n" +
	...
	"\n" +
	"created_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12R\n" +
	"\vclient_info\x18\x04 \x01(\v21.gomemo.store.RefreshTokensUserSetting.ClientInfoR\n" +
	"clientInfo\x12 \n" +
	...
	"\abrowser\x18\x05 \x01(\tR\abrowser\"\xa4\x03\n" +
	"\x1fPersonalAccessTokensUserSetting\x12Y\n" +
	"\x06tokens\x18\x01 \x03(\v2A.gomemo.store.PersonalAccessTokensUserSetting.PersonalAccessTokenR\x06tokens\x1a\xa5\x02\n" +
	...
	"\tshortcuts\x18\x01 \x03(\v2+.gomemo.store.ShortcutsUserSetting.ShortcutR\tshortcuts\x1aH\n" +
	"\bShortcut\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x16\n" +
	"\x06filter\x18\x03 \x01(\tR\x06filter\"\x9f\x01\n" +
	"\x13WebhooksUserSetting\x12E\n" +
	"\bwebhooks\x18\x01 \x03(\v2).gomemo.store.WebhooksUserSetting.WebhookR\bwebhooks\x1aA\n" +
	"\aWebhook\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x10\n" +
	"\x03url\x18\x03 \x01(\tR\x03urlB\xa3\x01\n" +
	"\x10com.gomemo.storeB\x10UserSettingProtoP\x01Z,github.com/momomo0206/gomemo/proto/gen/store\xa2\x02\x03GSX\xaa\x02\fGomemo.Store\xca\x02\fGomemo\\Store\xe2\x02\x18Gomemo\\Store\\GPBMetadata\xea\x02\rGomemo::Storeb\x06proto3"
...
var file_store_user_setting_proto_goTypes = []any{
	(UserSetting_Key)(0),                                        // 0: gomemo.store.UserSetting.Key
	(*UserSetting)(nil),                                         // 1: gomemo.store.UserSetting
	(*GeneralUserSetting)(nil),                                  // 2: gomemo.store.GeneralUserSetting
	(*RefreshTokensUserSetting)(nil),                            // 3: gomemo.store.RefreshTokensUserSetting
	(*PersonalAccessTokensUserSetting)(nil),                     // 4: gomemo.store.PersonalAccessTokensUserSetting
	(*ShortcutsUserSetting)(nil),                                // 5: gomemo.store.ShortcutsUserSetting
	(*WebhooksUserSetting)(nil),                                 // 6: gomemo.store.WebhooksUserSetting
	(*RefreshTokensUserSetting_RefreshToken)(nil),               // 7: gomemo.store.RefreshTokensUserSetting.RefreshToken
	(*RefreshTokensUserSetting_ClientInfo)(nil),                 // 8: gomemo.store.RefreshTokensUserSetting.ClientInfo
	(*PersonalAccessTokensUserSetting_PersonalAccessToken)(nil), // 9: gomemo.store.PersonalAccessTokensUserSetting.PersonalAccessToken
	(*ShortcutsUserSetting_Shortcut)(nil),                       // 10: gomemo.store.ShortcutsUserSetting.Shortcut
	(*WebhooksUserSetting_Webhook)(nil),                         // 11: gomemo.store.WebhooksUserSetting.Webhook
	(*timestamppb.Timestamp)(nil),                               // 12: google.protobuf.Timestamp
}
var file_store_user_setting_proto_depIdxs = []int32{
	0,  // 0: gomemo.store.UserSetting.key:type_name -> gomemo.store.UserSetting.Key
	2,  // 1: gomemo.store.UserSetting.general:type_name -> gomemo.store.GeneralUserSetting
	5,  // 2: gomemo.store.UserSetting.shortcuts:type_name -> gomemo.store.ShortcutsUserSetting
	6,  // 3: gomemo.store.UserSetting.webhooks:type_name -> gomemo.store.WebhooksUserSetting
	3,  // 4: gomemo.store.UserSetting.refresh_tokens:type_name -> gomemo.store.RefreshTokensUserSetting
	4,  // 5: gomemo.store.UserSetting.personal_access_tokens:type_name -> gomemo.store.PersonalAccessTokensUserSetting
	7,  // 6: gomemo.store.RefreshTokensUserSetting.refresh_tokens:type_name -> gomemo.store.RefreshTokensUserSetting.RefreshToken
	9,  // 7: gomemo.store.PersonalAccessTokensUserSetting.tokens:type_name -> gomemo.store.PersonalAccessTokensUserSetting.PersonalAccessToken
	10, // 8: gomemo.store.ShortcutsUserSetting.shortcuts:type_name -> gomemo.store.ShortcutsUserSetting.Shortcut
	11, // 9: gomemo.store.WebhooksUserSetting.webhooks:type_name -> gomemo.store.WebhooksUserSetting.Webhook
	12, // 10: gomemo.store.RefreshTokensUserSetting.RefreshToken.expires_at:type_name -> google.protobuf.Timestamp
	12, // 11: gomemo.store.RefreshTokensUserSetting.RefreshToken.created_at:type_name -> google.protobuf.Timestamp
	8,  // 12: gomemo.store.RefreshTokensUserSetting.RefreshToken.client_info:type_name -> gomemo.store.RefreshTokensUserSetting.ClientInfo
	12, // 13: gomemo.store.PersonalAccessTokensUserSetting.PersonalAccessToken.expires_at:type_name -> google.protobuf.Timestamp
	12, // 14: gomemo.store.PersonalAccessTokensUserSetting.PersonalAccessToken.created_at:type_name -> google.protobuf.Timestamp
	12, // 15: gomemo.store.PersonalAccessTokensUserSetting.PersonalAccessToken.last_used_at:type_name -> google.protobuf.Timestamp
