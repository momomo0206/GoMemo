...
const file_store_memo_proto_rawDesc = "" +
	"\n" +
	"\x10store/memo.proto\x12\fgomemo.store\"\xa2\x03\n" +
	"\vMemoPayload\x12>\n" +
	"\bproperty\x18\x01 \x01(\v2\".gomemo.store.MemoPayload.PropertyR\bproperty\x12>\n" +
	"\blocation\x18\x02 \x01(\v2\".gomemo.store.MemoPayload.LocationR\blocation\x12\x12\n" +
	...
	"\x10com.gomemo.storeB\tMemoProtoP\x01Z,github.com/momomo0206/gomemo/proto/gen/store\xa2\x02\x03GSX\xaa\x02\fGomemo.Store\xca\x02\fGomemo\\Store\xe2\x02\x18Gomemo\\Store\\GPBMetadata\xea\x02\rGomemo::Storeb\x06proto3"
...
var file_store_memo_proto_goTypes = []any{
	(*MemoPayload)(nil),          // 0: gomemo.store.MemoPayload
	(*MemoPayload_Property)(nil), // 1: gomemo.store.MemoPayload.Property
	(*MemoPayload_Location)(nil), // 2: gomemo.store.MemoPayload.Location
}
var file_store_memo_proto_depIdxs = []int32{
	1, // 0: gomemo.store.MemoPayload.property:type_name -> gomemo.store.MemoPayload.Property
	2, // 1: gomemo.store.MemoPayload.location:type_name -> gomemo.store.MemoPayload.Location
