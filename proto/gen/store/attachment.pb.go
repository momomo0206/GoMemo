...
func (x *AttachmentPayload) GetS3Object() *S3Object {
	if x != nil {
		if x, ok := x.Payload.(*AttachmentPayload_S3Object); ok {
			return x.S3Object
		}
	}
	return nil
...
type AttachmentPayload_S3Object struct {
	S3Object *S3Object `protobuf:"bytes,1,opt,name=s3_object,json=s3Object,proto3,oneof"`
}

func (*AttachmentPayload_S3Object) isAttachmentPayload_Payload() {}
...
func (x *S3Object) GetS3Config() *StorageS3Config {
	if x != nil {
		return x.S3Config
	}
	return nil
...
func (x *S3Object) GetLastPresignedTime() *timestamppb.Timestamp {
	if x != nil {
...
const file_store_attachment_proto_rawDesc = "" +
	"\n" +
	"\x16store/attachment.proto\x12\fgomemo.store\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cstore/instance_setting.proto\"U\n" +
	"\x11AttachmentPayload\x125\n" +
	"\ts3_object\x18\x01 \x01(\v2\x16.gomemo.store.S3ObjectH\x00R\bs3ObjectB\t\n" +
	"\apayload\"\xa4\x01\n" +
	"\bS3Object\x12:\n" +
	"\ts3_config\x18\x01 \x01(\v2\x1d.gomemo.store.StorageS3ConfigR\bs3Config\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12J\n" +
	"\x13last_presigned_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x11lastPresignedTime*a\n" +
	"\x15AttachmentStorageType\x12'\n" +
	"#ATTACHMENT_STORAGE_TYPE_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05LOCAL\x10\x01\x12\x06\n" +
	"\x02S3\x10\x02\x12\f\n" +
	"\bEXTERNAL\x10\x03B\xa2\x01\n" +
	"\x10com.gomemo.storeB\x0fAttachmentProtoP\x01Z,github.com/momomo0206/gomemo/proto/gen/store\xa2\x02\x03GSX\xaa\x02\fGomemo.Store\xca\x02\fGomemo\\Store\xe2\x02\x18Gomemo\\Store\\GPBMetadata\xea\x02\rGomemo::Storeb\x06proto3"
...
var file_store_attachment_proto_goTypes = []any{
	(AttachmentStorageType)(0),    // 0: gomemo.store.AttachmentStorageType
	(*AttachmentPayload)(nil),     // 1: gomemo.store.AttachmentPayload
	(*S3Object)(nil),              // 2: gomemo.store.S3Object
	(*StorageS3Config)(nil),       // 3: gomemo.store.StorageS3Config
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_store_attachment_proto_depIdxs = []int32{
	2, // 0: gomemo.store.AttachmentPayload.s3_object:type_name -> gomemo.store.S3Object
	3, // 1: gomemo.store.S3Object.s3_config:type_name -> gomemo.store.StorageS3Config
	4, // 2: gomemo.store.S3Object.last_presigned_time:type_name -> google.protobuf.Timestamp
...
func file_store_attachment_proto_init() {
	...
	file_store_attachment_proto_msgTypes[0].OneofWrappers = []any{
		(*AttachmentPayload_S3Object)(nil),
	}
	type x struct{}
