...
type IdentityProvider struct {
	...
	Type             IdentityProvider_Type   `protobuf:"varint,3,opt,name=type,proto3,enum=gomemo.store.IdentityProvider_Type" json:"type,omitempty"`
...
const file_store_idp_proto_rawDesc = "" +
	"\n" +
	"\x0fstore/idp.proto\x12\fgomemo.store\"\x84\x02\n" +
	"\x10IdentityProvider\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x127\n" +
	"\x04type\x18\x03 \x01(\x0e2#.gomemo.store.IdentityProvider.TypeR\x04type\x12+\n" +
	"\x11identifier_filter\x18\x04 \x01(\tR\x10identifierFilter\x12<\n" +
	"\x06config\x18\x05 \x01(\v2$.gomemo.store.IdentityProviderConfigR\x06config\"(\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06OAUTH2\x10\x01\"e\n" +
	"\x16IdentityProviderConfig\x12A\n" +
	"\roauth2_config\x18\x01 \x01(\v2\x1a.gomemo.store.OAuth2ConfigH\x00R\foauth2ConfigB\b\n" +
	"\x06config\"\x86\x01\n" +
	...
	"\rfield_mapping\x18\a \x01(\v2\x1a.gomemo.store.FieldMappingR\ffieldMappingB\x9b\x01\n" +
	"\x10com.gomemo.storeB\bIdpProtoP\x01Z,github.com/momomo0206/gomemo/proto/gen/store\xa2\x02\x03GSX\xaa\x02\fGomemo.Store\xca\x02\fGomemo\\Store\xe2\x02\x18Gomemo\\Store\\GPBMetadata\xea\x02\rGomemo::Storeb\x06proto3"
...
var file_store_idp_proto_goTypes = []any{
	(IdentityProvider_Type)(0),     // 0: gomemo.store.IdentityProvider.Type
	(*IdentityProvider)(nil),       // 1: gomemo.store.IdentityProvider
	(*IdentityProviderConfig)(nil), // 2: gomemo.store.IdentityProviderConfig
	(*FieldMapping)(nil),           // 3: gomemo.store.FieldMapping
	(*OAuth2Config)(nil),           // 4: gomemo.store.OAuth2Config
}
var file_store_idp_proto_depIdxs = []int32{
	0, // 0: gomemo.store.IdentityProvider.type:type_name -> gomemo.store.IdentityProvider.Type
	2, // 1: gomemo.store.IdentityProvider.config:type_name -> gomemo.store.IdentityProviderConfig
	4, // 2: gomemo.store.IdentityProviderConfig.oauth2_config:type_name -> gomemo.store.OAuth2Config
	3, // 3: gomemo.store.OAuth2Config.field_mapping:type_name -> gomemo.store.FieldMapping
