...
type InboxMessage struct {
	...
	// The type pf the inbox message.
	Type InboxMessage_Type `protobuf:"varint,1,opt,name=type,proto3,enum=gomemo.store.InboxMessage_Type" json:"type,omitempty"`
...
const file_store_inbox_proto_rawDesc = "" +
	"\n" +
	"\x11store/inbox.proto\x12\fgomemo.store\"\xa9\x01\n" +
	"\fInboxMessage\x123\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1f.gomemo.store.InboxMessage.TypeR\x04type\x12$\n" +
	...
	"\x10com.gomemo.storeB\n" +
	"InboxProtoP\x01Z,github.com/momomo0206/gomemo/proto/gen/store\xa2\x02\x03GSX\xaa\x02\fGomemo.Store\xca\x02\fGomemo\\Store\xe2\x02\x18Gomemo\\Store\\GPBMetadata\xea\x02\rGomemo::Storeb\x06proto3"
...
var file_store_inbox_proto_goTypes = []any{
	(InboxMessage_Type)(0), // 0: gomemo.store.InboxMessage.Type
	(*InboxMessage)(nil),   // 1: gomemo.store.InboxMessage
}
var file_store_inbox_proto_depIdxs = []int32{
	0, // 0: gomemo.store.InboxMessage.type:type_name -> gomemo.store.InboxMessage.Type
